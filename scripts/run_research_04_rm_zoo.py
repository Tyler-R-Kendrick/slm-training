#!/usr/bin/env python3
"""RESEARCH-04 / SLM-550: run default-off RM Zoo benchmark pilot.
    ...
    PYTHONPATH=src uv run python -m scripts.run_research_04_rm_zoo --write-lock
"""
...
from slm_training.harnesses.experiments.research_04_rm_zoo_benchmark import (
    ENABLE_FLAG,
    EVIDENCE_JSON,
    LOCK_RELPATH,
    load_campaign_lock,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json or not args.write:
        ...
        print(
            ...
            f"overclaim={result.get('overclaim_rate')} "

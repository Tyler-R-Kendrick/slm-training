#!/usr/bin/env python3
"""RESEARCH-10 / SLM-566: run default-off proof-strength curriculum pilot."""
...
from slm_training.harnesses.experiments.research_10_proof_strength_curriculum import (
    ENABLE_FLAG,
    EVIDENCE_JSON,
    LOCK_RELPATH,
    load_campaign_lock,

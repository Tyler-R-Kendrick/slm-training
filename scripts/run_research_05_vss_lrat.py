#!/usr/bin/env python3
"""RESEARCH-05 / SLM-563: run default-off VSS LRAT SAT pilot.
    ...
    PYTHONPATH=src uv run python -m scripts.run_research_05_vss_lrat --write-lock
"""
...
from slm_training.harnesses.experiments.research_05_vss_lrat import (
    ENABLE_FLAG,
    EVIDENCE_JSON,
    LOCK_RELPATH,
    load_campaign_lock,

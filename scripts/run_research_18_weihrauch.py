#!/usr/bin/env python3
"""RESEARCH-18 / SLM-551: run default-off Weihrauch/oracle multivalued classification pilot."""
...
from slm_training.harnesses.experiments.research_18_weihrauch_multivalued_classification import (
    ENABLE_FLAG,
    EVIDENCE_JSON,
    LOCK_RELPATH,
    load_campaign_lock,

#!/usr/bin/env python3
"""Run or verify the bounded SLM-219 correlation-trap retrospective."""
...
DEFAULT_JSON = "docs/design/iter-slm219-correlation-trap-20260723.json"
DEFAULT_MARKDOWN = "docs/design/iter-slm219-correlation-trap-20260723.md"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.check:
        if not json_path.is_file() or not markdown_path.is_file():
            print("missing committed SLM-219 result")
            return 1

#!/usr/bin/env python3
"""RESEARCH-20 / SLM-552: run default-off local cost kernel vs CSLib/Calf/AARA compare pilot."""
...
from slm_training.harnesses.experiments.research_20_cost_kernel_cslib_calf_aara_compare import (
    ENABLE_FLAG,
    EVIDENCE_JSON,
    LOCK_RELPATH,
    load_campaign_lock,

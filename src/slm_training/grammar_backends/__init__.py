...
from slm_training.grammar_backends.types import (
    GRAMMARS_DIR,
    GrammarBackend,
    GrammarInfo,
    REPO_ROOT,
...
def _ensure_builtins() -> None:
    ...
    from slm_training.grammar_backends.openui_hybrid import OpenUIHybridBackend
    from slm_training.grammar_backends.openui_langcore import OpenUILangCoreBackend
    from slm_training.grammar_backends.openui_lark import OpenUILarkBackend
    from slm_training.grammar_backends.toy_layout import ToyLayoutBackend

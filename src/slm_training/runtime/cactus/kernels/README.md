...
Training and local eval stay in PyTorch (`slm_training.dsl.grammar.fastpath`).
Export via `slm_training.runtime.cactus.export_checkpoint_bundle`, then transpile

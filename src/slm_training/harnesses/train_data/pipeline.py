...
def _normalize_record(
    ...
    *,
    ...
    # Canonicalize markers before stamping so the persisted verification report
    # describes the same bytes that are actually stored (finalize, then stamp).
    return stamp_record(_finalize(out))

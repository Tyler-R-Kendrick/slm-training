"""RESEARCH-06 / SLM-564: preregistered VSS PBLean PB pilot campaign.
...
EXPERIMENT_KEY = "RESEARCH-06"
LINEAR_ID = "SLM-564"
CAMPAIGN_ID = "research-06-vss-pblean"
EXPERIMENT_ID = "research_06_vss_pblean_pb"
EVIDENCE_MD = "docs/design/iter-revmath-research-06-preregistered.md"
EVIDENCE_JSON = "docs/design/iter-revmath-research-06-preregistered.json"
LOCK_RELPATH = (
    "src/slm_training/resources/formal/research_06_campaign_lock.v1.json"
)
ENABLE_FLAG = "SLM_ENABLE_RESEARCH_06"
...
def build_campaign_manifest(
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "hypothesis": (
            "For bounded VSS subsets dominated by cardinality-style constraints, "
            "verified VSS-to-PB plus checked PBLean/VeriPB-style certificates "
            "preserve exact agreement while making warm refutation cheaper than "
            "exhaustive replay."
        ),
        "decision": (
            "Accept iff zero witness disagreements, 100% mutation rejection, and "
            "median paired warm PBLean/exhaustive ratio < 1.0; else reject/retire."
        ),
        "endpoints": [
            {
                "endpoint_id": "warm_pblean_over_exhaustive_ratio",
                "metric": "median_paired_warm_pblean_check_over_exhaustive_replay_time_ratio",
                "role": "primary",
                "direction": "decrease",
                "minimum_effect": 0.0,
            },
            ...
            {
                "endpoint_id": "exact_semantic_agreement_rate",
                "metric": "exact_semantic_agreement_rate_on_supported_pb_subset",
                "role": "secondary",
                "direction": "increase",
                "minimum_effect": 0.0,
            },
        ...
        "controls": [
            ...
            },
            {
                ...
                "description": "Corrupt PBLean hints must not authorize unsat.",
                "kind": "negative",
            },
            {
                "control_id": "lrat_comparison_when_comparable",
                "description": "When RESEARCH-05 LRAT subset applies, outcomes must agree.",
                "kind": "positive",
            },
        ],
        ...
        "multiplicity_families": [
            {
                "family_id": "research06_primary",
                "hypothesis_ids": ["warm_pblean_over_exhaustive_ratio"],
                "alpha": 0.05,
            }
        ],
        "promotion_gates": [
...
def run_experiment(
    *,
    ...
    """Run RESEARCH-06. Refuses unless explicitly enabled (default-off)."""

    base = root or _repo_root()
    if not enabled:
        return {
            "schema": "research_06_experiment_result/v1",
    ...
    stamp = build_version_stamp(
        "harness.experiments.slm564_research06_vss_pblean",
    ...
    payload = {
        ...
        "exact_semantic_agreement_rate_on_supported_pb_subset": report[
            "exact_semantic_agreement_rate_on_supported_pb_subset"
        ],
        "mutation_rejection_rate": report["mutation_rejection_rate"],
        "supported_subset_coverage": report["supported_subset_coverage"],
        "lrat_comparable_n": report["lrat_comparable_n"],
        "lrat_agreement_n": report["lrat_agreement_n"],
...
def render_evidence_markdown(result: dict[str, Any]) -> str:
    ...
    return f"""# RESEARCH-06 — VSS pseudo-Boolean backend with PBLean (SLM-564)
...
| Exact semantic agreement (supported PB subset) | {result.get("exact_semantic_agreement_rate_on_supported_pb_subset")} |
| Mutation rejection rate | {result.get("mutation_rejection_rate")} |
| Supported-subset coverage | {result.get("supported_subset_coverage")} |
| LRAT comparable / agree | {result.get("lrat_comparable_n")} / {result.get("lrat_agreement_n")} |
| Median warm PBLean / exhaustive ratio | {ratio_s} |
| Decision | **{decision}** |

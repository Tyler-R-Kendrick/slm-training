...
class ExperimentKnobs(StrictModel):
    ...
    slot_component_focal_gamma: float | None = Field(default=None, ge=0, le=10)
    slot_component_class_balance_power: float | None = Field(
    ...
    slot_component_pair_interaction: bool | None = None
    slot_component_lexeme_prior_weight: float | None = Field(
        default=None, ge=0, le=20
    )
    slot_component_span_prior_weight: float | None = Field(
        default=None, ge=0, le=20
    )
    slot_component_content_arity: bool | None = None

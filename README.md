...
| --- | --- | --- | --- |
| Autotrain continuous-local c3 component-edge screen | 2 size-matched 1,766,987-param scratch checkpoints (control, component-edge) | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-local-8c0b60dd-c3/runs/` (local, explicit no-sync) | Both 20-step CPU arms completed smoke n=3 with identical quality metrics; component-edge is 10.5% faster p50 (+11.76% mpr_per_ms), an SDLC Phase A POSITIVE efficiency screening signal. Not yet confirmed/promoted/ship ([results](docs/design/continuous-openui-20260802-c3-results.md)) |
| Autotrain continuous-local c2 component-plan screen | 2 size-matched 1,755,764-param scratch checkpoints (control, component-plan) | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-local-8c0b60dd-c2/runs/` (local, explicit no-sync) | Both 20-step CPU arms completed smoke n=3; component-plan structural_similarity 0.0964 vs control 0.3267, a real -70.5% regression. Rejected; neither checkpoint reusable, promoted, synced, or ship ([results](docs/design/continuous-openui-20260802-c2-results.md)) |
| Autotrain continuous-local c1 infra screen | 2 scratch checkpoints (control, bounds) | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-local-8c0b60dd-c1/runs/` (local, explicit no-sync) | Both 21-step CPU arms trained; `evaluate_model --ship-gates` crashed on both (AgentV SDK unavailable, fixed in-cycle via `npm ci`), so the reported structural_similarity 0.0575/0.0575 is a crash fallback. Infrastructure-only; neither checkpoint reusable, promoted, synced, or ship ([results](docs/design/continuous-openui-20260802-c1-results.md)) |

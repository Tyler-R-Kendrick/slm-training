...
| E396 local ship-gate champion | `e396-balanced-type-head-continuation-r1/last.pt` | `outputs/runs/e396-balanced-type-head-continuation-r1/…` (local) | E442 honest five-suite gates pass with no failures and AgentV 5/5; full RICO n=1500 structure/recall 0.6390/0.8652. Local champion; production HF ship pending bucket sync |

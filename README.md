...
| E297 seed-1 DESIGN-dropout arm | `e297-choice-design-dropout50-seed1-r1/last.pt` | `outputs/runs/e297-choice-design-dropout50-seed1-r1/…` (local) | Cross-seed replication regresses NLL to 7.5864 and yields meaningful 0.0, AgentV 0/5, 17 failures — not promoted or ship |

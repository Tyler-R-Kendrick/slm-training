...
| E396 local ship-gate champion | `e396-balanced-type-head-continuation-r1/last.pt` | `outputs/runs/e396-balanced-type-head-continuation-r1/…` (local) | E456 repaired-corpus five-suite gates pass with no failures and AgentV 5/5; full RICO n=1500 meaningful/fidelity 1.0, structure/recall 0.8683/0.9960. Local champion; production HF ship pending bucket sync |

...
| --- | --- | --- | --- |
| E1418 v296 exact component-edge alignment replay | `e1418_v296_e1333_component_edge_alignment_replay/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1419 matches E1399: parse/meaningful 1.0, strict-v2 0.6, fidelity/contract recall 1.0, structure 0.6513, component recall 0.9429, reward 0.9616, zero timeouts, one fallback. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. Confirms current-v296 base compatibility; never sync/promote/serve/resume/parent |
| E1416 v296 component-edge replay | `e1416_v296_e1333_component_edge_replay/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1417 held-out n=5 named metrics: parse 1.0, meaningful 0.8, strict-v2 0.4, fidelity/contract recall 0.75, structure 0.47854, component recall 0.7429, reward 0.8758, zero timeouts, two fallbacks. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. Invalid comparison: the E1398 component-edge alignment loss was omitted. Never sync/promote/serve/resume/parent |
| E1414 v296 component-edge plus exact ownership control | `e1414_v296_e1333_component_edge_ownership/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1415 held-out n=5 named metrics exactly match E1413: parse 1.0, meaningful 0.8, strict-v2 0.4, fidelity/contract recall 0.75, structure 0.47854, component recall 0.7429, reward 0.8758, zero timeouts, two fallbacks. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. Rejected, never sync/promote/serve/resume/parent |
| E1412 v296 component-edge plus prefix-reference control | `e1412_v296_e1333_component_edge_prefix_presence/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1413 held-out n=5 named metrics: parse 1.0, meaningful 0.8, strict-v2 0.4, fidelity/contract recall 0.75, structure 0.47854, component recall 0.7429, reward 0.8758, zero timeouts, two fallbacks. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. Form still repeats forward `b7`. Rejected, never sync/promote/serve/resume/parent |
| E1409 v296 prefix binder-presence control | `e1409_v296_e1333_prefix_binder_presence/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1410 held-out n=5 named metrics exactly match E1405/E1403: parse 1.0, meaningful 0.8, strict-v2 0.6, fidelity/contract recall 0.8167, structure 0.54202, component recall 0.7810, reward 0.8958, zero timeouts, two fallbacks. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. Rejected, never sync/promote/serve/resume/parent |
| E1404 v295 forward binder-slot presence control | `e1404_v295_e1333_binder_slot_presence/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1405 held-out n=5 named metrics: parse 1.0, meaningful 0.8, strict-v2 0.6, fidelity/contract recall 0.8167, structure 0.54202, component recall 0.7810, reward 0.8958, zero timeouts, two fallbacks. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. Prediction-identical to E1403. Rejected, never sync/promote/serve/resume/parent |
| E1402 v294 forward binder-slot ownership control | `e1402_v294_e1333_binder_slot_ownership/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1403 held-out n=5 named metrics: parse 1.0, meaningful 0.8, strict-v2 0.6, fidelity/contract recall 0.8167, structure 0.54202, component recall 0.7810, reward 0.8958, zero timeouts, two fallbacks. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. Tabs collapses to TextContent. Rejected, never sync/promote/serve/resume/parent |
| E1398 v291 component-edge control | `e1398_v291_e1333_component_edge/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1399 held-out n=5 named metrics: parse/meaningful 1.0, strict-v2 0.6, fidelity/contract recall 1.0, structure 0.6513, component recall 0.9429, reward 0.9616, zero timeouts, one fallback. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. It did not exceed E1381's preregistered strict-v2 endpoint. Rejected, never sync/promote/serve/resume/parent |
| E1396 v291 activated exposure-targeted control | `e1396_v291_e1333_activated_exposure_targeted/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps with the sampler verified active; E1397 held-out n=5 named metrics: parse/meaningful 0.4, strict-v2 0.2, fidelity/contract recall 0.3667, structure 0.22688, component recall 0.3143, reward 0.3822, three timeouts. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. Rejected, never sync/promote/serve/resume/parent |
| E1394 v291 unactivated sampler control | `e1394_v291_e1333_exposure_targeted/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; the train summary records `mixture: null`, so exposure targeting never ran. E1395 matches E1381's named metrics exactly; 25 named graders through `@agentv/core`, zero errors, no aggregate metric. Invalid, never sync/promote/serve/resume/parent |
| E1392 v291 E1333 duration control | `e1392_v291_e1333_duration708/last.pt` | `outputs/runs/...` (local) | 708 CPU scratch steps; E1393 held-out n=5 named metrics: parse 0.6, meaningful-program/strict-v2 0.4, fidelity/contract recall 0.45, structure 0.33734, component recall 0.4667, reward 0.5136, two timeouts, two fallbacks. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. All tracked quality metrics regress from the shorter E1378 control. Rejected, never sync/promote/serve/resume/parent |
| E1386 v289 E1333 structural-fixture foreground control | `e1386_v289_e1333_structural_foreground/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1387 held-out n=5 named metrics: parse/meaningful-program 1.0, strict-v2 0.4, fidelity/contract recall 0.9267, structure 0.6325, component recall 0.8476, reward 0.9372, zero timeout, one fallback. E1389's opaque required-slot margin fires 16 times with zero choice changes; strict-v2 is unchanged. The 25 named graders ran through `@agentv/core` with zero errors and no aggregate metric. The immutable corpus is unchanged; human-curated sampling rises from 6.3% to 25%, but strict-v2 declines from 0.6. Rejected, never sync/promote/serve/resume/parent |
| E1378 v288 E1333 root-reference-identity control | `e1378_v288_e1333_root_identity_small/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1379/E1380 paired n=5 isolates root identity, strict-v2 0.4 to 0.6. E1381 v289 nested-uniqueness decode retains strict-v2 0.6 and improves structure 0.4987 to 0.54202 and component recall 0.7143 to 0.7810, while reward is 0.8958. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric. Promising local diagnostic only, never sync/promote/serve/resume/parent |
| E1376 v288 E1333 binder-topology supervision control | `e1376_v288_e1333_binder_topology_small/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1377 held-out n=5 named metrics: parse 1.0, meaningful-program 0.8, strict-v2 0.4, fidelity/contract recall 0.8167, structure 0.49536, component recall 0.7143, reward 0.8982, zero timeout, two fallbacks. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; no named metric improves over E1375 and structure declines from 0.5096. Rejected, never sync/promote/serve/resume/parent |
| E1366 v283 E1333 LTR-tail supervision control | `e1366_v283_e1333_ltr_tail32_small/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1367 Form n=1 named metrics match E1331: parse 1.0, strict-v2 0, fidelity/contract recall 0.1667, structure 0.1148, component recall 0.1429, reward 0.657, zero timeout, two fallbacks. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; tail weighting moved the completion forest to position 93 but did not produce b7. Rejected, never sync/promote/serve/resume/parent |
| E1364 v282 E1333 binder declaration-path control | `e1364_v282_e1333_binder_plan_decode2_small/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1365 Form n=1 named metrics match E1331: parse 1.0, strict-v2 0, fidelity/contract recall 0.1667, structure 0.1148, component recall 0.1429, reward 0.657, zero timeout, two fallbacks. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; the binder planner applied twice but changed no choice before the b7 dead end. Rejected, never sync/promote/serve/resume/parent |
| E1362 v282 E1333 LTR-supervision control | `e1362_v282_e1333_ltr1_semantic_exhaustive_small/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1363 Form n=1 named metrics match E1331: parse 1.0, strict-v2 0, fidelity/contract recall 0.1667, structure 0.1148, component recall 0.1429, reward 0.657, zero timeout, two fallbacks. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; three changed choices still retained the b7 dead end. Rejected, never sync/promote/serve/resume/parent |
| E1360 v282 E1333 semantic-exhaustive margin control | `e1360_v282_e1333_semantic_exhaustive_margin1_small/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1361 Form n=1 named metrics match E1331: parse 1.0, strict-v2 0, fidelity/contract recall 0.1667, structure 0.1148, component recall 0.1429, reward 0.657, zero timeout, two fallbacks. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; five changed choices still retained the b7 dead end. Rejected, never sync/promote/serve/resume/parent |
| E1358 v282 E1333 semantic-exhaustive compiler-alignment control | `e1358_v282_e1333_semantic_exhaustive_alignment_small/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1359 Form n=1 named metrics match E1331: parse 1.0, strict-v2 0, fidelity/contract recall 0.1667, structure 0.1148, component recall 0.1429, reward 0.657, zero timeout, two fallbacks. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; semantic-exhaustive alignment made three choice changes but retained the same b7 dead end. Rejected, never sync/promote/serve/resume/parent |
| E1355 v282 E1333 stratified compiler-alignment control | `e1355_v282_e1333_stratified_compiler_alignment_small/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1356 Form n=1 named metrics match E1331: parse 1.0, strict-v2 0, fidelity/contract recall 0.1667, structure 0.1148, component recall 0.1429, reward 0.657, zero timeout, two fallbacks. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; five of eight semantic-plan choice changes still ended in an empty completion forest and the same minimal prediction. Rejected, never sync/promote/serve/resume/parent |
| E1352 v282 E1333 typed component-plan control | `e1352_v282_e1333_component_plan_small_batch1/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1353/E1354 Form n=1 named metrics are identical: parse 1.0, strict-v2 0, fidelity/contract recall 0.1667, structure 0.1148, component recall 0.1429, reward 0.657, zero timeout, two fallbacks. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; component plan applied three times but changed no choice at weights 1/4, binder arity did not apply. Rejected, scalar sweep closed, never sync/promote/serve/resume/parent |
| E1342 v282 E1338 isolated Form control | `e1342_v282_e1338_isolated_title_form_control/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1344 Form n=1 named metrics all 0 with one empty timeout. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; rejected, never sync/promote/serve/resume/parent |
| E1335 v282 E1333 title-plus-Form control | `e1335_v282_e1333_title_form_lexer_control/last.pt` | `outputs/runs/...` (local) | 354 CPU scratch steps; E1336 Form n=1 named metrics: parse 1.0, strict-v2 0, fidelity/contract recall 0.1667, structure 0.1148, component recall 0.1429, reward 0.657, zero timeout, two fallbacks. The 25 graders ran through `@agentv/core` with zero execution errors and no aggregate metric; prediction-identical to E1331, rejected and never sync/promote/serve/resume/parent |
| E1318 v276 E1308 matched-auxiliary control | `e1318_v276_e1308_matched_auxiliary_control/last.pt` | `outputs/runs/...` (local) | 291 CPU scratch steps; E1319 held-out n=5 named grader metrics are parse/strict-v2/fidelity/structure/recall/component recall 0.2 and reward 0.1874, with four empty timeouts. Later v279 decoder-only evaluation reaches parse 0.8, fidelity/recall 0.6333, structure 0.4589, component recall 0.4619, and reward 0.6936 but strict-v2 remains 0.2. The 25 graders ran through `@agentv/core` with no aggregate metric; rejected, never sync/promote/serve/resume/parent |
| E1316 v276 E1308 foreground mixture control | `e1316_v276_e1308_form_capacity_foreground_control/last.pt` | `outputs/runs/...` (local) | 291 single-writer CPU scratch steps; held-out n=5 named grader metrics: parse/strict-v2/fidelity/structure/recall/component recall 0.2 and reward 0.1874, with four empty decode timeouts. The 25 graders ran through `@agentv/core` with no aggregate AgentV metric; rejected, never sync/promote/serve/resume/parent |
| E1312 v275 E1308 Form-capacity mixture control | `e1312_v275_e1308_form_capacity_control/last.pt` | `outputs/runs/...` (local) | 291 CPU scratch steps via a 199-step full-state continuation; held-out n=5 parse 0.4, strict-v2 0.2, fidelity 0.25, structure 0.17934, recall 0.26667, reward 0.3238, three timeouts, and two fallbacks. Auxiliary objectives differ from E1301, so it is a non-causal negative signal; rejected, never sync/promote/serve/resume/parent |
| E1301 v274 E1298 multi-slot scratch control | `e1301_v274_e1298_multislot_control/last.pt` | `outputs/runs/...` (local) | 332 own-state CPU steps on E1298's 442 strict documents; corrected v275 full held-out n=5 gives parse 1.0, strict-v2 0.4, fidelity 0.6933, structure 0.4324, recall 0.6952, reward 0.8558, and two fallback attempts. The 25 named graders ran through `@agentv/core`, with no aggregate AgentV metric; rejected, never sync/promote/serve/resume/parent |
| E1294 v273 fidelity-1 scratch control | `e1294_v273_e1291_fidelity1_control/last.pt` | `outputs/runs/...` (local) | 263 own-state CPU steps on the E1291 document corpus, changing only fidelity loss from 0.5 to 1.0; final held-out Settings n=1 timed out empty, so parse/fidelity/strict-v2/structure/recall/reward are all 0; rejected, never sync/promote/serve/resume/parent |
| E1292 v272 document-only scratch control | `e1292_v272_e1291_document_control/last.pt` | `outputs/runs/...` (local) | 263 own-state CPU steps on 350 complete documents; held-out n=5 has parse 1.0, v1 0.8, structure 0.6087, recall 0.6524, reward 0.7632, no timeouts, but strict-v2 0/5 from missing slots and schema-role errors; rejected, never sync/promote/serve/parent |
| E1287 v272 fresh E937 scratch control | `e1287_v272_e937_fresh_control_tty/last.pt` | `outputs/runs/...` (local) | 395 own-state CPU steps; held-out Settings n=1 is strict-invalid decode-off (strict-v2 0, fidelity 0.3333, recall 0, reward 0.707) and becomes an empty 12s timeout decode-on through named `@agentv/core` graders; root-identity sweep rejected, never sync/promote/serve/parent |
| E1080 v272 root-identity reproduction | `e1080_v272_root_identity_repro/last.pt` | `outputs/runs/...` (local) | Exact 395 steps / 179.94 cumulative train seconds; paired Settings decode weights 0/1 both have parse 1.0 but strict-v2 0 and fidelity 0.3333; rejected, unsynced/not promoted/served/parentable |
| E1075 v272 root-identity diagnostic | `e1075_v272_root_identity_395/last.pt` | `outputs/runs/...` (local) | Exact 395 steps / 100.16 cumulative train seconds; E1076 smoke strict-v2/fidelity 1.0 with two identity-driven choice changes, but E1077 Dual Card still times out. Required evaluation criteria fail; rejected, not synced/promoted/served/parentable |
...
| E1011 exposure-targeted scratch diagnostic | `e1011-role-safe-exposure450-r1/last.pt` | `outputs/runs/...` (local) | 450 fresh E937 steps / 87.11s; E1013 held strict-v2 0 / fidelity 0.47 / structure 0.2457 / six fallbacks, AgentV 0/2 — rejected, never use as parent |
| E1006 topology-data scratch diagnostic | `e1006-role-safe-topology450-r1/last.pt` | `outputs/runs/...` (local) | 450 fresh E1005 steps / 56.62s; E1008 held strict-v2 0.4 / fidelity 0.57 / structure 0.3965 / one timeout / two fallbacks, AgentV 0/2 — rejected, never use as parent |

...
| --- | --- | --- | --- |
| Autotrain scheduled-loop `0805a` c4 batch-size diagnostic | 2 size-matched 1,608,962-param CPU scratch checkpoints | `outputs/autoresearch/continuous-loop-20260805-continuous-openui-schedu-e7f55102-c4/runs/` (local, explicit no-sync) | Runtime-only `batch1` throughput lever, structural_similarity tied `.4167/.4167` as expected (not a quality hypothesis). **Non-positive; no reuse/promote/sync/ship** ([results](docs/design/continuous-openui-scheduled-0805a-c4-results.md)) |
| Autotrain scheduled-loop `0805a` c3 fresh-seed confirmation | 2 size-matched 1,755,764-param CPU scratch checkpoints | `outputs/autoresearch/continuous-loop-20260805-continuous-openui-schedu-e7f55102-c3/runs/` (local, explicit no-sync) | c2's `component-plan` win did not reproduce on a fresh seed (structural_similarity delta null) and `binder_reference_f1` regressed `.4889→.2667`. **Champion rejected; no reuse/promote/sync/ship** ([results](docs/design/continuous-openui-scheduled-0805a-c3-results.md)) |
| Autotrain scheduled-loop `0805a` c2 component-plan screen | 2 size-matched 1,755,764-param CPU scratch checkpoints | `outputs/autoresearch/continuous-loop-20260805-continuous-openui-schedu-e7f55102-c2/runs/` (local, explicit no-sync) | Fixture structural win `.3267→.3828`, lower latency (no tradeoff spent); size-matched, no tracked code delta so no stack PR. **Candidate queued for fresh-seed confirmation; not promotable/synced/ship-eligible yet** ([results](docs/design/continuous-openui-scheduled-0805a-c2-results.md)) |
| Autotrain scheduled-loop `0805a` c1 screening | 2 size-matched 1,608,962-param CPU scratch checkpoints | `outputs/autoresearch/continuous-loop-20260805-continuous-openui-schedu-e7f55102-c1/runs/` (local, explicit no-sync) | Both arms trained/evaluated cleanly (exit 0); honest `--ship-gates` reject on fixture `n=3`, structural-similarity delta null (`.0575/.0575`). **Non-positive; no stack layer, no reuse/promote/sync/ship** ([results](docs/design/continuous-openui-scheduled-0805a-c1-results.md)) |

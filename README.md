...
| E505 replay-loss attribution checkpoint | `e505-e396-e500-replay050-loss-attribution-r1-5k/last.pt` | `outputs/runs/e505-…/` (local) | E506–E509 confirm constrained OOD meaningful 0.25, fidelity 0.2583, and reward 0.692. Slot-contract context only raises structure to 0.2406; AgentV remains red, with no sync or promotion |

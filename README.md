...
| --- | --- | --- | --- |
| E1075 v272 root-identity partial | `e1075_v272_root_identity_395/last.pt` | `outputs/runs/...` (local) | 378/395 fresh E937 steps / 95.13s; 220/524 observed strict-subset roots, identity loss/exact/positive-recall/negative-accuracy 0.6189/0.3333/1.0/0.0. Pending own-state resume only; not evaluated, synced, promoted, served, or parentable |

...
| E1080 v272 root-identity reproduction | `e1080_v272_root_identity_repro/last.pt` | `outputs/runs/...` (local) | Exact 395 steps / 179.94 cumulative seconds; E1092 identity-decode-off Settings still times out empty (all headline metrics 0) — rejected, unsynced/not promoted/served/parentable |

...
| E297 seed-1 DESIGN-dropout arm | `e297-choice-design-dropout50-seed1-r1/last.pt` | `outputs/runs/e297-choice-design-dropout50-seed1-r1/…` (local) | Cross-seed replication regresses NLL to 7.5864. E299's opt-in content floor cuts failures 17→12 but regresses structure and remains AgentV 0/5 — not promoted or ship |

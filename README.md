...
| B3 five-minute choice arm | `capacity_choice_v1__d64_h2_c1_dn2_t5000_x1__s0/last.pt` | `outputs/ladders/b3-matched-5m-e287-r2/…` (local) | 107-step / 5,022-token CPU scratch; empty-decode defect, five-suite parse/meaningful 0.0, AgentV 0/5 — not promoted or ship |

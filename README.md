...
| --- | --- | --- | --- |
| E951 role-safe warm-start diagnostic | `e951-e891-role-safe-warm20-r1/last.pt` | `outputs/runs/…` (local) | E957 held-out n=5 parse 1.0 / meaning 0.8 / strict-v2 0.8 / structure 0.4434 / recall 0.6952 / zero role violations, AgentV 0/2 — decoder treatment retained, checkpoint not promotable because parent E891 predates role safety |

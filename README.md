...
| --- | --- | --- | --- |
| Autotrain local-c3 component-plan screen | 2 size-matched scratch checkpoints (control 1,608,962 / component-plan 1,755,764 params) | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-local-8c0b60dd-c3/runs/` (local, explicit no-sync) | component-plan regresses smoke structural_similarity (.2308→.1725) and binder_reference_f1 vs its matched control at 20 steps. Rejected; neither checkpoint reusable, promoted, synced, or ship ([results](docs/design/continuous-openui-local-20260802-c3-results.md)) |
| Autotrain local-c2 frozen replay (AgentV unblock) | 2 exactly matched 1,608,962-param scratch checkpoints | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-local-8c0b60dd-c2/runs/` (local, explicit no-sync) | Frozen replay of local-c1 after installing the missing `@agentv/core` npm dep; exact smoke n=3 quality tie, 0.0 primary-metric delta, gates fail on `insufficient_n`. Rejected; neither checkpoint reusable, promoted, synced, or ship ([results](docs/design/continuous-openui-local-20260802-c2-results.md)) |
| Autotrain local-c1 bounds screen (AgentV blocked) | 2 exactly matched 1,608,962-param scratch checkpoints | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-local-8c0b60dd-c1/runs/` (local, explicit no-sync) | Both 21-step CPU trains completed but `evaluate_model --ship-gates` crashed on a missing AgentV SDK (fresh checkout, no `npm ci` yet) — no scoreboard on either arm. Incomplete; frozen replay required (see local-c2) ([results](docs/design/continuous-openui-local-20260802-c1-results.md)) |

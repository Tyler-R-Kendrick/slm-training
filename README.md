...
| --- | --- | --- | --- |
| Autotrain continuous-openui-local c5 component-edge screen | 2 size-matched 1,766,987-param CPU scratch checkpoints | `outputs/autoresearch/continuous-loop-20260803-continuous-openui-local-8c0b60dd-c5/runs/` (local, explicit no-sync) | Exact smoke `n=3` quality tie: structure `.0431`, meaningful `0`, binder F1 `.8222`. `--ship-gates` fail (`insufficient_n`). **Quality-null; no promote/sync/ship** ([results](docs/design/autotrain-cycle-c5-component-edge-quality-null.md)) |
| Autotrain continuous-openui-local c4 component-plan screen | 2 size-matched 1,755,764-param CPU scratch checkpoints | `outputs/autoresearch/continuous-loop-20260803-continuous-openui-local-8c0b60dd-c4/runs/` (local, explicit no-sync) | Exact smoke `n=3` quality tie: structure `.4167`, meaningful `.3333`, recall `.25`, AST `0`. `--ship-gates` fail (`insufficient_n`, quality thresholds). **Quality-null; no promote/sync/ship** ([results](docs/design/autotrain-cycle-c4-component-plan-quality-null.md)) |
| Autotrain continuous-openui-local c2/c3 AgentV-gap frozen replay | 2 size-matched 1,608,962-param CPU scratch checkpoints, retrained then replayed | `outputs/autoresearch/continuous-loop-20260803-continuous-openui-local-8c0b60dd-{c2,c3}/runs/` (local, explicit no-sync) | c2 trained but AgentV SDK was missing in this sandbox (infra, not a model result; fixed by `npm ci`). c3 frozen replay: exact smoke `n=3` tie, structure `.3267`, `--ship-gates` fail (`insufficient_n`). **Quality-null; no promote/sync/ship** ([c2 results](docs/design/autotrain-cycle-c2-agentv-missing-infra-failure-repro2.md), [c3 results](docs/design/autotrain-cycle-c3-frozen-replay-fixture-gate-reject.md)) |

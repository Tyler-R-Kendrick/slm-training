...
| E505 replay-loss attribution checkpoint | `e505-e396-e500-replay050-loss-attribution-r1-5k/last.pt` | `outputs/runs/e505-…/` (local) | Primary and replay token-loss proxies both decline. E506 constrained decode reaches meaningful 0.1538, fidelity 0.2538, and reward 0.5454 across 13 diagnostics, but AgentV is 0/3 and the canvas is below suite p95; no sync or promotion |

...
| E292 judged semantic-contract choice arm | `capacity_choice_v1__d64_h2_c1_dn2_t5000_x1__s0/last.pt` | `outputs/ladders/e292-semantic-contract-data/…` (local) | Matched best NLL improves to 6.50945 and the generalized DSL-policy decoder restores parse 1.0, but meaningful/fidelity/reward remain zero and AgentV is 0/5 — not model-promoted or ship |

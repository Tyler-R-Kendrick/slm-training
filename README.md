...
| E505 replay-loss attribution checkpoint | `e505-e396-e500-replay050-loss-attribution-r1-5k/last.pt` | `outputs/runs/e505-…/` (local) | E511 component-plan decode reaches aggregate meaningful 0.3846, fidelity 0.6718, structure 0.3440, and AST edge F1 0.1748 across 13 records. Strict semantic and AgentV 0/3 remain red; no promotion |

...
| E621 typed-array margin decoupling sweep (3-seed, 800-step) | `e621-margin-sweep-seed{0,1,2}-scratch800-20260720/last.pt` | `outputs/runs/e621-margin-sweep-seed{0,1,2}-scratch800-20260720/` (local) | 3 seeds x 800 CPU scratch steps; sweeping `semantic_plan_typed_array_nonempty_margin_decode_weight` at 0/2/6 gave 36/36 byte-identical OOD predictions — subsumed by the always-on `item_margin` sibling, confirmed by instrumentation + full-ablation rerun — not ship |

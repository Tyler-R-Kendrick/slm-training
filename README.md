...
| E396 durable diagnostic checkpoint | `e396-balanced-type-head-continuation-r1/last.pt` | `hf://buckets/TKendrick/OpenUI/checkpoints/e396-balanced-type-head-continuation-r1/` | Exact SHA `feefa056…c2f2eee0`; bucket verified. E490 is branch-only 5/5 evidence; E496 proves current `main` cannot load its slot-component head. Incompatible, not a current-main champion or ship |

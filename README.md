...
| --- | --- | --- | --- |
| E1075 v272 root-identity diagnostic | `e1075_v272_root_identity_395/last.pt` | `outputs/runs/...` (local) | Exact 395 steps / 100.16 cumulative train seconds; E1076 smoke strict-v2/fidelity 1.0, structure 0.5396, recall 0.75, reward 0.965, zero timeouts/fallbacks, two identity-driven choice changes, AgentV 0/1. Pending targeted held; not synced, promoted, served, or parentable |

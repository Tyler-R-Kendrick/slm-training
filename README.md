...
| Autotrain continuous-openui-local c22 | bounds fixture — **not ship** |
| Autotrain continuous-openui-local c23 | binder-arity fixture — **not ship** |
| Autotrain continuous-openui-local c24 | binder-component-plan fixture — **not ship** |
| Autotrain continuous-openui-local c25 | slot-component-fidelity-coupling fixture — **not ship** |
| Autotrain continuous-openui-local c26 | binder-component-plan fixture — **not ship** |
...
| Autotrain continuous-openui-local c31 | slot-component-fidelity-coupling fixture — **not ship** |
| Autotrain continuous-openui-local c32 | slot-component-inventory-coupling fixture — **not ship** |
| Autotrain continuous-openui-local c33 | slot-component-fidelity-coupling fixture — **not ship** |
| Autotrain continuous-openui-local c34 | slot-component-inventory-coupling fixture — **not ship** |
| Autotrain continuous-openui-local c35 | slot-contract-context fixture — **not ship** |
| Autotrain continuous-openui-local c36 | constraint-graph fixture — **not ship** |
| Autotrain continuous-openui-local c37 | slot-contract-context fixture — **not ship** |
| Autotrain continuous-openui-local c38 | constraint-graph fixture — **not ship** |
| Autotrain continuous-openui-local c39 | fidelity fixture — **not ship** |
| Autotrain continuous-openui-local c40 | edge-alignment fixture — **not ship** |
| Autotrain continuous-openui-local c41 | fidelity fixture — **not ship** |
| Autotrain continuous-openui-local c42 | edge-alignment fixture — **not ship** |
...
| Autotrain continuous-openui-local c47 | bounds fixture — **not ship** |

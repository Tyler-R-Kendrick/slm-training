...
| --- | --- | --- | --- |
| SLM-313 AbstractPlan local checkpoint | `slm313_local_plan_1k_v1/last.pt` | `outputs/runs/…` (local, no-sync) | 9-step / 1,006-token CPU scratch plan-head + learned-connector run. Locked plan-control matrix not yet measured; not reusable, promoted, or ship ([evidence](docs/design/abstract-plan-functional-evidence.md)) |

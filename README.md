...
| E396 balanced type-supervision candidate | `e396-balanced-type-head-continuation-r1/last.pt` | `outputs/runs/e396-balanced-type-head-continuation-r1/…` (local) | 22,044 target tokens in 104.6s; bounded AgentV 4/4 and held recall 0.4833. Matched RICO-48 structure/recall dip to 0.6401/0.8993; full RICO missing — not promoted or ship |
...
| E423 low-LR continuation candidate | `e423-component-plan-23k-low-lr-r1/last.pt` | `outputs/runs/e423-component-plan-23k-low-lr-r1/…` (local) | Effective LR `3e-5`, 19 resumed steps / 23,019 tokens; bounded AgentV 4/4 and held recall 0.5833, but full RICO/fresh loss/sync are absent — not promoted or ship |

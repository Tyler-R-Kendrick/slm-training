...
| --- | --- | --- | --- |
| E1029 joint detached binder-plans scratch diagnostic | `e1029_v268_joint_binder_plans/last.pt` | `outputs/runs/...` (local) | 450 fresh E937 steps / 54.83s; E1031 held strict-v2 0.4 / fidelity 0.44 / recall 0.4 / two timeouts, binder-component applications 0, AgentV 0/2 — rejected, never use as parent |

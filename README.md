...
| --- | --- | --- | --- |
| Autotrain 1pse54 c4 promotion decode timeout | 2 size-matched 1,755,764-param scratch checkpoints | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-1pse54-c1f3ee08-c4/runs/` (local, explicit no-sync) | Both trains completed but every document on both arms hit the decode timeout during promotion-role evaluation; AgentV bridge itself ran cleanly. Infrastructure only; neither checkpoint reusable, promoted, synced, or ship ([results](docs/design/autotrain-cycle-1pse54-c4-promotion-decode-timeout.md)) |
| Autotrain 1pse54 c2 AgentV NODE_OPTIONS block | 2 size-matched 1,608,962-param scratch checkpoints | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-1pse54-c1f3ee08-c2/runs/` (local, explicit no-sync) | Both trains completed but evaluation was blocked on both arms by an unsanitized NODE_OPTIONS crashing the AgentV node subprocess; repaired in commit `46fecfc`. Infrastructure only; neither checkpoint reusable, promoted, synced, or ship ([results](docs/design/autotrain-cycle-1pse54-c2-agentv-node-options-block.md)) |

...
| --- | --- | --- | --- |
| E1075 v272 root-identity diagnostic | `e1075_v272_root_identity_395/last.pt` | `outputs/runs/...` (local) | Exact 395 steps / 100.16 cumulative train seconds; 220/524 observed strict-subset roots, identity loss/exact/positive-recall/negative-accuracy 0.5937/0.6667/1.0/0.25. Pending strict smoke; not synced, promoted, served, or parentable |

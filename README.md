...
| E505 replay-loss attribution checkpoint | `e505-e396-e500-replay050-loss-attribution-r1-5k/last.pt` | `outputs/runs/e505-…/` (local) | E506 constrained decode improves 13-record semantics; E507 confirms OOD meaningful 0.25, fidelity 0.2583, and reward 0.692 at a length-safe 160-token canvas. AgentV remains red; no sync or promotion |

...
| --- | --- | --- | --- |
| Autotrain c1804 component-token incomplete | 2 size-matched 1,608,962-param scratch checkpoints | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1804/runs/` (local, explicit no-sync) | Control timed out 3/3, so candidate MPR `.6667`, recall `.3333`, fidelity `1.0`, structure `.08173`, and p50 `7462.88` ms are non-attributable. Exact frozen replay only; neither checkpoint reusable, promoted, synced, or ship ([results](docs/design/autotrain-cycle-1804-component-token-incomplete.md)) |

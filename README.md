...
| --- | --- | --- | --- |
| E1071 v271 395-step exposure diagnostic | `e1071_v271_bound_only_arity_395/last.pt` | `outputs/runs/...` (local) | Exact 395 steps / 107.13 cumulative train seconds; E1072 smoke strict-v2/fidelity 1.0 / structure 0.5717 / recall 0.75, AgentV 0/1. Targeted held pending; local and non-parentable |

...
| --- | --- | --- | --- |
| Autotrain c1840 incomplete promotion | 2 size-matched 1,608,962-param scratch checkpoints | `outputs/autoresearch/continuous-loop-20260803-continuous-openui-202607-98199209-c1840/runs/` (local, explicit no-sync) | Lean proved; both trains completed, but no smoke (0/3) or held-out (0/5) document was scoreable under the unreclaimed formal-lane budget. No model conclusion; exact frozen eval replay only ([results](docs/design/autotrain-cycle-1840-promotion-budget-incomplete.md)) |

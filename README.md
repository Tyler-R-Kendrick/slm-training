...
| --- | --- | --- | --- |
| Autotrain 8c0b60dd-c6 component-inventory exact tie (session j48f8u) | 2 size-matched scratch checkpoints | `outputs/autoresearch/continuous-loop-20260803-continuous-openui-local-8c0b60dd-c6/runs/` (local, explicit no-sync) | `component-inventory` ties control exactly on every smoke quality metric despite higher training loss; fourth exact-tie this session. Never reusable/promoted/synced/ship ([results](docs/design/continuous-openui-local-j48f8u-c6-results.md)) |
| Autotrain 8c0b60dd-c5 component-edge exact tie (session j48f8u) | 2 size-matched scratch checkpoints | `outputs/autoresearch/continuous-loop-20260803-continuous-openui-local-8c0b60dd-c5/runs/` (local, explicit no-sync) | `component-edge` ties control exactly on every smoke quality metric despite higher training loss; never reusable/promoted/synced/ship ([results](docs/design/continuous-openui-local-j48f8u-c5-results.md)) |
| Autotrain 8c0b60dd-c4 batch-size exact tie (session j48f8u) | 2 size-matched scratch checkpoints | `outputs/autoresearch/continuous-loop-20260803-continuous-openui-local-8c0b60dd-c4/runs/` (local, explicit no-sync) | `batch1` ties control exactly on every smoke quality metric despite higher training loss; never reusable/promoted/synced/ship ([results](docs/design/continuous-openui-local-j48f8u-c4-results.md)) |
| Autotrain 8c0b60dd-c3 champion confirmation rejected (session j48f8u) | 2 size-matched scratch checkpoints | `outputs/autoresearch/continuous-loop-20260803-continuous-openui-local-8c0b60dd-c3/runs/` (local, explicit no-sync) | Fresh-seed confirmation of the c2 champion falsifies it: `structural_similarity` ties exactly and `confirm` regresses `binder_reference_f1`/`placeholder_fidelity`/`reward_score` vs its own control. Never reusable/promoted/synced/ship ([results](docs/design/continuous-openui-local-j48f8u-c3-results.md)) |

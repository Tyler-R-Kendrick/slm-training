...
| --- | --- | --- | --- |
| E1071 v271 395-step exposure diagnostic | `e1071_v271_bound_only_arity_395/last.pt` | `outputs/runs/...` (local) | Exact 395 steps / 107.13 cumulative train seconds; final typed binder loss/accuracy/candidates 0.9040/0.7692/15.46. Strict smoke pending; local and non-parentable |

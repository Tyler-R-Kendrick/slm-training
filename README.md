...
| E224 semantic-exhaustive alignment diagnostic | `e224-semantic-exhaustive-matched` | `outputs/autoresearch/e224-semantic-exhaustive-alignment/runs/…` (local) | AST-role rows rose 74.7%, but strict semantic metrics remained 0.0 with 12 failed gates — not ship |

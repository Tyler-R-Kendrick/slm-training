...
| --- | --- | --- | --- |
| E1066 dedicated root-arity scratch diagnostic | `e1066_v271_dedicated_root_arity/last.pt` | `outputs/runs/...` (local) | 331 fresh E937 steps / 95.24s; dedicated root-reference arity final loss/accuracy 1.2019/0.50. Evaluation pending — local no-sync diagnostic, never use as parent |

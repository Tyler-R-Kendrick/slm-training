...
| --- | --- | --- | --- |
| E1029 joint detached binder-plans scratch diagnostic | `e1029_v268_joint_binder_plans/last.pt` | `outputs/runs/...` (local) | 450 fresh E937 steps / 54.83s; E1031 held strict-v2 0.4 / fidelity 0.44 / recall 0.4 / two timeouts. v269 E1032-E1038 makes the component head reachable before declaration but leaves held metrics unchanged; AgentV 0/8 — rejected, never use as parent |

...
| --- | --- | --- | --- |
| Autotrain c1840/c1841 tail promotion | 2 size-matched 1,608,962-param scratch checkpoints | c1840 trains + c1841 hash-linked eval replay under `outputs/autoresearch/` (local, explicit no-sync) | Lean proved and repaired replay completed. Candidate/control held-out structure both `.30788`, MPR `0`, AST/canonical `0`; candidate p50 +2.4%. Rejected as a robust OpenUI lever; never promote/sync/ship ([results](docs/design/autotrain-cycle-1841-promotion-held-out-null.md)) |

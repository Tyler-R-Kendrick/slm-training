...
| --- | --- | --- | --- |
| E1069 331-step exposure control | `e1069_v271_331_step_control/last.pt` | `outputs/runs/...` (local) | 331 steps / 100.92 cumulative train seconds after own full-state resume; strict smoke pending. Not yet comparable or parentable |

...
| E505 replay-loss attribution checkpoint | `e505-e396-e500-replay050-loss-attribution-r1-5k/last.pt` | `outputs/runs/e505-…/` (local) | E506–E508 confirm constrained OOD meaningful 0.25, fidelity 0.2583, and reward 0.692 at length-safe/default generation settings. AgentV remains red; no sync or promotion |

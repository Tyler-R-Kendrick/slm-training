...
| --- | --- | --- | --- |
| E1071 v271 395-step exposure diagnostic | `e1071_v271_bound_only_arity_395/last.pt` | `outputs/runs/...` (local) | First bounded invocation reached 342/395 steps / 95.18s; own full-state resume pending for 53 steps. Not yet comparable or parentable |

...
| --- | --- | --- | --- |
| E1066 dedicated root-arity scratch diagnostic | `e1066_v271_dedicated_root_arity/last.pt` | `outputs/runs/...` (local) | 331 fresh E937 steps / 95.24s; E1067 smoke parse 1.0 / strict-v2 0.6667 / fidelity 0.9167 / recall 0.6667 / reward 0.9320; AgentV 0/1 — rejected, never use as parent |

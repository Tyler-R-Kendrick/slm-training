...
| E505 replay-loss attribution checkpoint | `e505-e396-e500-replay050-loss-attribution-r1-5k/last.pt` | `outputs/runs/e505-…/` (local) | E510 component-plan decode reaches OOD meaningful 0.50, fidelity 0.6583, structure 0.3446, and reward 0.8405. Strict semantic and AgentV gates remain red; no sync or promotion |

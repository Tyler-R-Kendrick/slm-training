...
| --- | --- | --- | --- |
| E1045 typed binder-candidate scratch diagnostic | `e1045_v270_typed_binder_candidates/last.pt` | `outputs/runs/...` (local) | 395 fresh E937 steps / 95.16s; E1047-E1051 held diagnostics strict-v2 0.6 / fidelity 0.6667 / recall 0.5333 / one timeout. Arity weights 0/0.5/0.75/1 expose opposed Dual Card/Settings thresholds; AgentV 0/17 — v270 retained, checkpoint rejected and never use as parent |

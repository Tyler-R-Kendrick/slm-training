...
| E505 replay-loss attribution checkpoint | `e505-e396-e500-replay050-loss-attribution-r1-5k/last.pt` | `outputs/runs/e505-…/` (local) | Primary and replay token-loss proxies both decline, falsifying simple divergence. Constrained slot-contract decode recovers some fidelity/reward but meaningful rate and AgentV remain zero; no sync or promotion |

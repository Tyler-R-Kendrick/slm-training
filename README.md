...
| E396 local ship-gate champion | `e396-balanced-type-head-continuation-r1/last.pt` | `outputs/runs/e396-balanced-type-head-continuation-r1/…` (local) | E479 current-policy five-suite gates pass with no failures and AgentV 5/5; smoke structure/recall 0.6822/0.6667, OOD 0.6343/0.8750, full RICO n=1500 meaningful/fidelity/recall 1.0 and structure 0.8736. Local champion; production HF ship pending bucket sync |

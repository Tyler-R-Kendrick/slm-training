"""Tests for the SLM-236 structural-similarity literal-content robustness
probe CLI."""
...
from scripts.run_slm236_structural_similarity_literal_content_robustness import main
...
def test_plan_only_mode(tmp_path: Path) -> None:
    ...
    assert (
        payload["matrix_set"]
        == "slm236_structural_similarity_literal_content_robustness"
    )
    assert payload["rows"] == []

"""Tests for the SLM-237 placeholder-contract literal-content robustness
probe CLI."""
...
from scripts.run_slm237_placeholder_contract_literal_content_robustness import main
...
def test_plan_only_mode(tmp_path: Path) -> None:
    ...
    assert (
        payload["matrix_set"]
        == "slm237_placeholder_contract_literal_content_robustness"
    )
    assert payload["rows"] == []

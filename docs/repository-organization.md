...
| Evidence interop projections (PROV-O / RO-Crate / SPDX / in-toto / OCI; authority stays native) | `src/slm_training/evidence_interop/` (see `docs/design/evidence-interop-profile.md`) |

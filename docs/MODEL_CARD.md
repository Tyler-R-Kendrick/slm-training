...
| --- | --- | --- | --- | --- |
| E1029 joint detached binder-plans scratch diagnostic | `e1029_v268_joint_binder_plans` | CPU scratch role-safe joint binder diagnostic | `outputs/runs/e1029_v268_joint_binder_plans/checkpoints/last.pt` (local) | 450 steps / 54.83s, SHA `41955a28...1b9f2f`; E1031 held n=5 parse 0.6 / strict-v2 0.4 / fidelity 0.44 / structure 0.2395 / recall 0.4 / reward 0.5106 / two timeouts / three fallbacks, binder-component applications 0, AgentV 0/2 — **rejected; never sync/promote/serve/resume/use as parent** ([results](design/iter-e1029-e1031-joint-binder-plans-20260722.md)) |

...
| E980 binder-arity scratch diagnostic | `e980-role-safe-binder-arity450-r1` | CPU scratch weighted role-safe corpus diagnostic | `outputs/runs/e980-role-safe-binder-arity450-r1/checkpoints/last.pt` (local) | 450 steps / 36.93s, SHA `76a2b78d...14bb0`; E982 held weight-1 n=5 parse 1.0 / strict-v2 0.4 / fidelity 0.8833 / structure 0.5038 / recall 0.7190 / reward 0.9284, but smoke timed out and strict fell to 0.6667, AgentV 0/1 per valid split — **rejected; never sync/promote/serve/resume/use as parent** ([results](design/iter-e939-e952-role-safe-decoding-20260722.md)) |
...
| 2026-07-23 | `e980-role-safe-binder-arity450-r1` | `outputs/runs/e980-role-safe-binder-arity450-r1/` (local) | E982 held weight-1 n=5 parse 1.0 / strict-v2 0.4 / fidelity 0.8833 / structure 0.5038 / recall 0.7190 / reward 0.9284, AgentV 0/1; smoke has one timeout | 450 clean weighted E937 scratch steps in 36.93s with binder-arity loss 1; explicit no-sync diagnostic, rejected and never use as parent |

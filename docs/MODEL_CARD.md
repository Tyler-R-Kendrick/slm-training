...
| --- | --- | --- | --- | --- |
| 2026-07-23 | `e1071_v271_bound_only_arity_395` | `outputs/runs/e1071_v271_bound_only_arity_395/` (local) | 342/395 steps complete; no evaluation yet | 95.18s, SHA `0dbeed64...6935832`; resume only its own full-state checkpoint for 53 steps |

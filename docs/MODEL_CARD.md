...
| --- | --- | --- | --- | --- |
| E1075 v272 root-identity partial | `e1075_v272_root_identity_395` | CPU scratch role-safe lexer root-identity diagnostic | `outputs/runs/e1075_v272_root_identity_395/checkpoints/last.pt` (local) | 378/395 fresh E937 steps / 95.13s, SHA `ffd06d4f...3792a2e`; 220/524 strict-subset roots, identity loss/exact/positive-recall/negative-accuracy 0.6189/0.3333/1.0/0.0 — **partial pending own-state resume; never evaluate/sync/promote/serve/use as parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |
...
| --- | --- | --- | --- | --- |
| 2026-07-23 | `e1075_v272_root_identity_395` | `outputs/runs/e1075_v272_root_identity_395/` (local) | No evaluation; valid 378/395-step internal-wall partial | 95.13s, SHA `ffd06d4f...3792a2e`; 220/524 strict-subset roots; resume only its own full state for 17 steps |

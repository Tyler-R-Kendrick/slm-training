...
| 2026-07-15 | `e120_unsandboxed` | `outputs/runs/iter-e120-unsandboxed-20260715/e120_unsandboxed/` (local) | 8 CPU scratch steps; `rico_held n=1` parse 0.0, fidelity 0.375 | Singleton/root/arity decoder diagnostic; no sync, promotion, or ship claim; [evidence](design/iter-e120-singleton-legality-20260715.md) |

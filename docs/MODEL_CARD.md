...
| E396 balanced type-supervision candidate | `e396-balanced-type-head-continuation-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e396-balanced-type-head-continuation-r1/checkpoints/last.pt` (local) | 427 cumulative steps / 22,044 target tokens in 104.6s; bounded AgentV 4/4 and held recall 0.4833, but matched RICO-48 structure/recall regress to 0.6401/0.8993 and full RICO is missing — **not promoted or ship** ([results](design/iter-e396-e399-balanced-type-supervision-20260718.md)) |
...
| `smoke` (E396/E398 balanced type supervision) | 3 | 1.0 | 1.0 | 0.5600 | 0.9770 | Yes for bounded suite; no global ship |
| `held_out` (E396/E398 balanced type supervision) | 5 | 1.0 | 1.0 | 0.5933 | 0.5916 | Yes for bounded suite; recall 0.4833 |
| `adversarial` (E396/E398 balanced type supervision) | 4 | 1.0 | 1.0 | 0.6762 | 0.7268 | Yes for bounded suite; no global ship |
| `ood` (E396/E398 balanced type supervision) | 4 | 1.0 | 1.0 | 0.5511 | 0.9827 | Yes for bounded suite; no global ship |
| `rico_held` (E396/E399 matched diagnostic shard) | 48 | 1.0 | 1.0 | 0.6401 | 0.9991 | No — only rows 336–384; recall 0.8993 and full RICO missing |

...
| `smoke` (`e224-semantic-exhaustive-matched`, E225 corrected tree) | 3 | 0.0 | 0.0 | 0.4625 | 0.0 | No — component recall 0.25, but schema-invalid output |
| `held_out` (`e224-semantic-exhaustive-matched`, E225 corrected tree) | 5 | 0.0 | 0.0 | 0.4597 | 0.0 | No — component recall 0.1567; strict gate failure |
| `adversarial` (`e224-semantic-exhaustive-matched`, E225 corrected tree) | 4 | 0.0 | 0.0 | 0.5784 | 0.0 | No — component recall 0.4583; strict gate failure |
| `ood` (`e224-semantic-exhaustive-matched`, E225 corrected tree) | 4 | 0.0 | 0.0 | 0.3059 | 0.0 | No — component recall 0.2083; strict gate failure |
| `rico_held` (`e224-semantic-exhaustive-matched`, E225 corrected tree) | 3 | 0.0 | 0.0 | 0.5729 | 0.0 | No — component recall 0.4444; strict gate failure |
...
| 2026-07-16 | `e224-semantic-exhaustive-matched` (E224–E225) | `outputs/autoresearch/e224-semantic-exhaustive-alignment/runs/e224-semantic-exhaustive-matched/` (local) | 32 CPU steps; loss 15.9786; corrected tree eval structure 0.4625–0.5784 on four suites and component recall up to 0.4583, but syntax/parse 0.0 | Original eval superseded after tree-mode activation bug; corrected AgentV 0/5; checkpoint SHA `c9f38df1…22bb8ef`; no sync or promotion |

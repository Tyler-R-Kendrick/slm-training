...
| --- | --- | --- | --- | --- |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c3-{control,component-plan}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c3/runs/` (local, explicit no-sync) | Exact smoke n=3 quality ties: parse 1.0, meaning .3333, structure .23083, binder F1 .4889, reward .5493; component-plan p50 2,392.58 vs control 2,539.57 ms (-5.79%, faster); AgentV complete, gates fail | CPU `wf_smoke_v2`, 22 steps, seed 100003, batch 2; exactly matched 1,755,764-param arms. Control SHA `57d5b8f1…56c4f95`; component-plan SHA `e80f27c2…dbfd5cfc2`. Clean code `aa60c0ac661d230a8c20fde900d8faf3f9a34b13`, harness `v74`, meaning eval `2.13.0`, scoring `v22`. **Positive** (SDLC Phase A): quality-held, `mpr_per_ms` efficiency gain 6.14% (≥5% floor); champion candidate queued. Fixture-scale single-seed screening only; not promoted/synced/ship ([results](design/autotrain-cycle-1743-component-plan-latency-win.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c2-{control,bounds}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c2/runs/` (local, explicit no-sync) | Exact smoke n=3 quality ties: parse 1.0, meaning 0, structure .0964, binder F1 0, reward 0; bounds p50 1,193.63 vs control 1,126.16 ms (+5.99%, slower); AgentV complete, gates fail | CPU `wf_smoke_v2`, 22 steps, seed 100002, batch 2; exactly matched 1,608,962-param arms. Control SHA `76044b81…6ca2e26a8`; bounds SHA `de1c3077…d4697a86dfc`. Clean code `b18898a8238615d7d2b4bcb6e187815f94b00bab`, harness `v74`, meaning eval `2.13.0`, scoring `v22`. Second independent seed confirms c1741: `grammar_completion_bounds` quality-null and slower; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1742-grammar-bounds-repeat-screen.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1-{control,bounds}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1/runs/` (local, explicit no-sync) | Exact smoke n=3 quality ties: parse 1.0, meaning 0, structure .0575, binder F1 .6333, reward 0; bounds p50 1,436.09 vs control 1,278.91 ms (+12.29%, slower); AgentV complete, gates fail | CPU `wf_smoke_v2`, 23 steps, seed 100001, batch 2; exactly matched 1,608,962-param arms. Control SHA `08ea9557…64628b7`; bounds SHA `26b846b1…5062e3`. Clean code `b8188a49672f187146bf1a76a353cbe188f9b99d`, harness `v74`, meaning eval `2.13.0`, scoring `v22`. This session's checkout was missing the pinned AgentV SDK (`npm ci` not yet run), which failed the first `--ship-gates` pass with `AgentV SDK is unavailable` before any scoreboard was published; fixed with `npm ci` and re-evaluating the identical frozen checkpoints. `grammar_completion_bounds` quality-null and slower; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1741-grammar-bounds-latency-regression.md)) |

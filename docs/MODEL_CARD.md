...
| E396 local ship-gate champion | `e396-balanced-type-head-continuation-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e396-balanced-type-head-continuation-r1/checkpoints/last.pt` (local) | E465 current-policy five-suite gates pass with no failures and AgentV 5/5; smoke structure/recall 0.6822/0.6667 and full RICO n=1500 meaningful/fidelity/recall 1.0 with structure 0.8740. **Local champion; production HF ship pending durable bucket sync** ([train](design/iter-e396-e399-balanced-type-supervision-20260718.md), [full gates](design/iter-e465-e396-explicit-callout-full-ship-gates-20260718.md)) |
...
| `smoke` (E396/E465 full gates) | 3 | 1.0 | 1.0 | 0.6822 | 0.9730 | Yes; meaningful 1.0, recall 0.6667 |
| `held_out` (E396/E465 full gates) | 5 | 1.0 | 1.0 | 0.8023 | 0.9862 | Yes; meaningful 1.0, recall 0.9048 |
| `adversarial` (E396/E465 full gates) | 4 | 1.0 | 1.0 | 0.8061 | 0.9767 | Yes; meaningful/recall 1.0 |
| `ood` (E396/E465 full gates) | 4 | 1.0 | 1.0 | 0.5835 | 0.9835 | Yes; meaningful 1.0, recall 0.8125 |
| `rico_held` (E396/E460/E465 full gates) | 1500 | 1.0 | 1.0 | 0.8740 | 0.9939 | Yes; meaningful/recall 1.0, zero recorded failures |

...
| E423 low-LR continuation candidate | `e423-component-plan-23k-low-lr-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e423-component-plan-23k-low-lr-r1/checkpoints/last.pt` (local) | 19 resumed steps / 23,019 tokens at effective LR `3e-5`; bounded AgentV 4/4 and held recall 0.5833, but full RICO/fresh loss/sync are absent — **not promoted or ship** ([results](design/iter-e423-e425-low-lr-continuation-20260718.md)) |
...
| 2026-07-18 | `e423-component-plan-23k-low-lr-r1` (E423 effective low-LR continuation) | `outputs/runs/e423-component-plan-23k-low-lr-r1/` (local) | Full-state resume from E396 after fixing LR override; all AdamW groups at `3e-5`; 446 cumulative CPU steps / 23,019 target tokens in 21.6s; SHA `2a6b84ba7259937bbaf1e3edb712f2adde4ce8cdef0be6cbcc55e7ffa260e3ad`; inherited best NLL 5.8091; explicit no-sync | Matched E425 bounded AgentV 4/4; avoids E411 smoke collapse and raises held recall to 0.5833; no fresh loss/full RICO, not promoted |

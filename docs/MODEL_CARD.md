...
| --- | --- | --- | --- | --- |
| E1294 v273 fidelity-1 scratch control | `e1294_v273_e1291_fidelity1_control` | CPU scratch fresh E1291 document-only fidelity-1 control | `outputs/runs/e1294_v273_e1291_fidelity1_control/checkpoints/last.pt` (local) | 263 own-state CPU steps, SHA `a737aa49...f814cec1`; final held-out Settings n=1 timed out empty, so parse/fidelity/strict-v2/structure/recall/reward are all 0 through 25 named `@agentv/core` graders — **rejected; never sync/promote/serve/resume/use as parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |
| E1292 v272 document-only scratch control | `e1292_v272_e1291_document_control` | CPU scratch fresh E1291 document-only control | `outputs/runs/e1292_v272_e1291_document_control/checkpoints/last.pt` (local) | 263 own-state CPU steps, SHA `7d48e2b9...fdf852b8`; held-out n=5 parse 1.0, v1 0.8, structure 0.6087, recall 0.6524, reward 0.7632, no timeout/fallback, but strict-v2 0/5 from required-slot and schema-role failures through 25 named `@agentv/core` graders — **rejected; never sync/promote/serve/use as parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |
| E1287 v272 fresh E937 scratch control | `e1287_v272_e937_fresh_control_tty` | CPU scratch fresh E937 root-identity control | `outputs/runs/e1287_v272_e937_fresh_control_tty/checkpoints/last.pt` (local) | 395 own-state CPU steps, SHA `52974b70...ed1dc3e`; held-out Settings n=1 is strict-invalid decode-off (strict-v2 0, fidelity 0.3333, recall 0, reward 0.707) and empty 12s timeout decode-on through named `@agentv/core` graders with zero execution errors — **root-identity decode sweep rejected; never sync/promote/serve/use as parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |
| E1080 v272 root-identity reproduction | `e1080_v272_root_identity_repro` | CPU scratch role-safe lexer root-identity reproduction | `outputs/runs/e1080_v272_root_identity_repro/checkpoints/last.pt` (local) | Exact 395 steps / 179.94 cumulative train seconds, SHA `eae1afd2...54623d`; paired Settings weights 0/1 both have parse 1.0 but strict-v2 0 and fidelity 0.3333 despite active decode choices — **rejected; never sync/promote/serve/use as parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |
| E1075 v272 root-identity diagnostic | `e1075_v272_root_identity_395` | CPU scratch role-safe lexer root-identity diagnostic | `outputs/runs/e1075_v272_root_identity_395/checkpoints/last.pt` (local) | Exact 395 steps / 100.16 cumulative train seconds, SHA `9e035753...2122c7`; E1076 smoke strict-v2/fidelity 1.0 with two identity-driven choice changes, but E1077 Dual Card still times out and required evaluation criteria fail — **rejected; never sync/promote/serve/use as parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |
...
| --- | --- | --- | --- | --- |
| 2026-07-24 | `e1294_v273_e1291_fidelity1_control` | `outputs/runs/e1294_v273_e1291_fidelity1_control/` (local) | Matched held-out Settings n=1: 12s empty timeout; parse / v1 / strict-v2 / fidelity / structure / recall / reward all 0 | 263 own-state CPU steps, SHA `a737aa49...f814cec1`; only change vs E1292 is fidelity loss 0.5→1.0. One default-smoke zero-row preflight is non-evidence; corrected 25-name `@agentv/core` run had zero SDK execution errors. Rejected: never sync/promote/serve/resume/use as parent |
| 2026-07-24 | `e1292_v272_e1291_document_control` | `outputs/runs/e1292_v272_e1291_document_control/` (local) | Held-out n=5 parse 1.0 / v1 0.8 / strict-v2 0 / fidelity 0.3967 / structure 0.6087 / recall 0.6524 / reward 0.7632 / zero timeout or fallback | 263 own-state CPU steps, SHA `7d48e2b9...fdf852b8`; 25 named `@agentv/core` graders, zero SDK execution errors; required-slot and schema-role errors remain, rejected and never sync/promote/serve/use as parent |
| 2026-07-24 | `e1287_v272_e937_fresh_control_tty` | `outputs/runs/e1287_v272_e937_fresh_control_tty/` (local) | Settings n=1 strict-invalid decode-off; decode-on is empty 12s timeout via named `@agentv/core` graders | 395 own-state CPU steps, SHA `52974b70...ed1dc3e`, zero SDK execution errors; root-identity decode sweep rejected, never sync/promote/serve/use as parent |
| 2026-07-24 | `e1080_v272_root_identity_repro` | `outputs/runs/e1080_v272_root_identity_repro/` (local) | E1081/E1082 Settings weights 0/1 both strict-invalid: parse 1.0, strict-v2 0, fidelity 0.3333 | 179.94 cumulative train seconds, SHA `eae1afd2...54623d`; rejected scratch, never sync/promote/serve/use as parent |

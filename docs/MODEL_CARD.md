...
| E292 judged semantic-contract choice arm | `capacity_choice_v1__d64_h2_c1_dn2_t5000_x1__s0` | CPU scratch matched-capacity choice codec | `outputs/ladders/e292-semantic-contract-data/runs/capacity_choice_v1__d64_h2_c1_dn2_t5000_x1__s0/checkpoints/last.pt` (local) | New judged corpus lowers matched best NLL to 6.50945; DSL-policy repair restores parse 1.0 without retraining, but meaningful/fidelity/reward remain zero and AgentV is 0/5 — **not model-promotable or ship** ([results](design/iter-e292-semantic-contract-data-20260717.md)) |
...
| `smoke` (E292 semantic-contract data) | 3 | 1.0 | 0.0 | 0.2519 | 0.0 | No — valid but trivial layout; AgentV row failed |
| `held_out` (E292 semantic-contract data) | 5 | 1.0 | 0.0 | 0.2021 | 0.0 | No — valid but trivial layout; AgentV row failed |
| `adversarial` (E292 semantic-contract data) | 4 | 1.0 | 0.0 | 0.2364 | 0.0 | No — valid but trivial layout; AgentV row failed |
| `ood` (E292 semantic-contract data) | 4 | 1.0 | 0.0 | 0.1906 | 0.0 | No — valid but trivial layout; AgentV row failed |
| `rico_held` (E292 semantic-contract data) | 3 | 1.0 | 0.0 | 0.0727 | 0.0 | No — valid but trivial layout; AgentV row failed |
...
| 2026-07-17 | `capacity_choice_v1__d64_h2_c1_dn2_t5000_x1__s0` (E292 judged semantic-contract data) | `outputs/ladders/e292-semantic-contract-data/runs/capacity_choice_v1__d64_h2_c1_dn2_t5000_x1__s0/` (local) | 107 CPU scratch steps / 5,022 target tokens / 20.44s; committed 480-record corpus; best weighted NLL 6.50945; SHA `f74a3c46…120b26` | Same-checkpoint DSL-policy repair restores parse 1.0 and zero dead ends, but meaningful/fidelity/reward 0.0 and AgentV 0/5; scratch/no sync/no model promotion |

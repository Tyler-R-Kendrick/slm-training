...
| E368 bounded Card continuation | `e368-card-hierarchy-adapt-18k-local-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e368-card-hierarchy-adapt-18k-local-r1/checkpoints/last.pt` (local) | Stopped cleanly at the 4.5-minute wall budget after 15,091/18,000 target tokens; E375's decoder reaches RICO-16 fidelity 0.9896 / structure 0.6619, but 16/1500 is diagnostic only — **not promoted or ship** ([results](design/iter-e372-e375-structural-terminal-coverage-20260717.md)) |
...
| 2026-07-17 | `e368-card-hierarchy-adapt-18k-local-r1` (E368 bounded continuation) | `outputs/runs/e368-card-hierarchy-adapt-18k-local-r1/` (local) | Full-state resume from E360; 293 cumulative CPU steps / 15,091 target tokens; stopped on 4.5-minute wall budget at 270.4s; last-checkpoint SHA `a7dd2d79df0c3c36f80e1bb81349f7dad663d9796d201ffff492535a11982573`; inherited best NLL 5.8091; explicit no-sync | E375 RICO-16 parse 1.0 / fidelity 0.9896 / structure 0.6619 / reward 0.9965, but AgentV 0/1 for partial coverage; no promotion |

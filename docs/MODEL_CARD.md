...
| --- | --- | --- | --- | --- |
| E1066 dedicated root-arity scratch diagnostic | `e1066_v271_dedicated_root_arity` | CPU scratch role-safe dedicated root-reference arity diagnostic | `outputs/runs/e1066_v271_dedicated_root_arity/checkpoints/last.pt` (local) | 331 steps / 95.24s, SHA `51ffed4a...1b8ff22`; final root-reference arity loss/accuracy 1.2019/0.50, last-50 1.3583/0.5367 — **evaluation pending; never sync/promote/serve/resume/use as parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |
...
| --- | --- | --- | --- | --- |
| 2026-07-23 | `e1066_v271_dedicated_root_arity` | `outputs/runs/e1066_v271_dedicated_root_arity/` (local) | Dedicated root-reference arity final loss/accuracy 1.2019/0.50, last-50 1.3583/0.5367; evaluation pending | 331 fresh E937 steps in 95.24s, SHA `51ffed4a...1b8ff22`; explicit no-sync diagnostic, never use as parent before evaluation |

...
| --- | --- | --- | --- | --- |
| 2026-07-23 | `e1045_v270_typed_binder_candidates` | `outputs/runs/e1045_v270_typed_binder_candidates/` (local) | E1047-E1051 held diagnostics parse 0.8 / strict-v2 0.6 / fidelity 0.6667 / structure 0.3762 / recall 0.5333 / reward 0.7132 / one timeout / three fallbacks; arity scalar sweep shows opposed row thresholds, AgentV 0/17 | 395 fresh E937 steps in 95.16s, SHA `dc39d2f1...22eef1`; explicit no-sync diagnostic, v270 retained, checkpoint rejected |

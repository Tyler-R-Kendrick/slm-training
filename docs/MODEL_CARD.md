...
| --- | --- | --- | --- | --- |
| E1045 typed binder-candidate scratch diagnostic | `e1045_v270_typed_binder_candidates` | CPU scratch role-safe typed binder diagnostic | `outputs/runs/e1045_v270_typed_binder_candidates/checkpoints/last.pt` (local) | 395 steps / 95.16s, SHA `dc39d2f1...22eef1`; E1047-E1051 held diagnostics parse 0.8 / strict-v2 0.6 / fidelity 0.6667 / structure 0.3762 / recall 0.5333 / reward 0.7132 / one timeout / three fallbacks, AgentV 0/6 — **v270 retained; checkpoint never sync/promote/serve/resume/use as parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |

...
| E621 typed-array margin decoupling sweep (3-seed, 800-step) | `e621-margin-sweep-seed{0,1,2}-scratch800-20260720` | CPU scratch TwoTower powered margin-sweep diagnostic | `outputs/runs/e621-margin-sweep-seed{0,1,2}-scratch800-20260720/checkpoints/last.pt` (local) | 3 seeds x 800 steps on E530 (~29s each), losses 4.0680/4.5998/3.4020. Sweeping `semantic_plan_typed_array_nonempty_margin_decode_weight` at 0/2/6 across all 3 seeds produced 36/36 byte-identical OOD predictions — instrumentation traced this to the weight's target-selection being subsumed by its always-on sibling `semantic_plan_typed_array_item_margin_decode_weight`; a full-ablation confirmation (both weights zeroed) reproduces the E610/E612/E616 empty-array-close failure. Strict-v2 remains 0.0; **not promotable or ship** ([results](design/iter-e621-typed-array-margin-decoupling-20260720.md)) |
...
| `ood` (`e621-seed{0,1,2}-margin{0,2,6}-r1`, pooled 3-seed x 3-dose subset) | 12 | 1.0 | 0.55/0.6333/0.625 by seed (dose-invariant) | 0.4886/0.5248/0.4368 by seed | 0.814/0.8375/0.443 by seed | No — 36/36 predictions byte-identical across dose 0/2/6; strict-v2 0.0 in every arm; margin lever subsumed by its sibling (see E621) |
...
| --- | --- | --- | --- | --- |
| 2026-07-20 | `e621-margin-sweep-seed{0,1,2}-scratch800-20260720` | `outputs/runs/e621-margin-sweep-seed{0,1,2}-scratch800-20260720/` (local) | 36/36 OOD predictions byte-identical across margin 0/2/6, all 3 seeds; strict-v2 0.0 | 3-seed no-sync scratch powered sweep; margin lever subsumed by `item_margin` sibling, code-level instrumentation traced root cause; rejected |

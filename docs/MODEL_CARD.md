...
| --- | --- | --- | --- | --- |
| E951 role-safe warm-start diagnostic | `e951-e891-role-safe-warm20-r1` | CPU scratch role-safe continuation diagnostic | `outputs/runs/e951-e891-role-safe-warm20-r1/checkpoints/last.pt` (local) | 20 steps / 2.91s, SHA `1646f0b6…905e4b`; E952 held-out n=5 strict-v2 0.2 / structure 0.2 / recall 0.2 / four timeouts, AgentV 0/2; zero role violations across all eight predictions — **quality rejection; never sync, promote, serve, resume, or use as parent** ([results](design/iter-e939-e952-role-safe-decoding-20260722.md)) |
...
| --- | --- | --- | --- | --- |
| 2026-07-23 | `e951-e891-role-safe-warm20-r1` | `outputs/runs/e951-e891-role-safe-warm20-r1/` (local) | E952 held-out n=5 parse/strict/fidelity/structure/recall 0.2, four timeouts, AgentV 0/2 | 20 clean E937 warm-start steps in 2.91s; zero role violations across eight predictions but catastrophic quality/latency; explicit no-sync rejection, never use as parent |

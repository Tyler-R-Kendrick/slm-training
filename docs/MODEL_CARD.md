...
| E368 bounded Card continuation | `e368-card-hierarchy-adapt-18k-local-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e368-card-hierarchy-adapt-18k-local-r1/checkpoints/last.pt` (local) | Stopped cleanly at the 4.5-minute wall budget after 15,091/18,000 target tokens; E376 passes bounded AgentV 4/4 and E388 reaches contiguous RICO-336 fidelity 0.9893 / structure 0.6366, but full RICO is missing — **not promoted or ship** ([results](design/iter-e387-e388-structural-capacity-rico336-20260718.md)) |
...
| `rico_held` (E368/E388 structural merge) | 336 | 1.0 | 0.9893 | 0.6366 | 0.9949 | No — strong contiguous partial evidence, but only 336/1500 |
...
| 2026-07-17 | `e368-card-hierarchy-adapt-18k-local-r1` (E368 bounded continuation) | `outputs/runs/e368-card-hierarchy-adapt-18k-local-r1/` (local) | Full-state resume from E360; 293 cumulative CPU steps / 15,091 target tokens; stopped on 4.5-minute wall budget at 270.4s; last-checkpoint SHA `a7dd2d79df0c3c36f80e1bb81349f7dad663d9796d201ffff492535a11982573`; inherited best NLL 5.8091; explicit no-sync | E376 bounded AgentV 4/4; E388 contiguous RICO-336 fidelity 0.9893 / structure 0.6366 with zero failures, but full RICO is missing; no promotion |

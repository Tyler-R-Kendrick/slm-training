...
| E368 bounded Card continuation | `e368-card-hierarchy-adapt-18k-local-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e368-card-hierarchy-adapt-18k-local-r1/checkpoints/last.pt` (local) | Stopped cleanly at the 4.5-minute wall budget after 15,091/18,000 target tokens; corrected E393 bounded AgentV is 3/4 and E392 RICO rows 336–384 reach fidelity 1.0 / structure 0.6514. E376–E390 used an actual 58-token canvas despite reporting 320 and are invalid for selection — **not promoted or ship** ([results](design/iter-e389-e395-choice-effective-canvas-20260718.md)) |
| E396 local ship-gate champion (durable checkpoint) | `e396-balanced-type-head-continuation-r1` | CPU frozen SmolLM2 full-state continuation | `hf://buckets/TKendrick/OpenUI/checkpoints/e396-balanced-type-head-continuation-r1` | E490 current-policy five-suite gates pass with no failures and AgentV 5/5; smoke structure/recall 0.6822/0.6667, OOD 0.6343/0.8750, and full RICO n=1500 meaningful/fidelity/recall 1.0 with structure 0.8737. **Durable HF bucket checkpoint; serving promotion unchanged** ([train](design/iter-e396-e399-balanced-type-supervision-20260718.md), [full gates](design/iter-e490-e396-json-number-typed-any-full-ship-gates-20260718.md)) |
| E400 component-plan balance rejection | `e400-component-plan-balanced-continuation-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e400-component-plan-balanced-continuation-r1/checkpoints/last.pt` (local) | 567 cumulative steps / 29,066 target tokens in 106.8s; settings improves, but smoke meaningful/recall collapse to 0.3333/0.1667 and AgentV is 3/4 — **rejected, not ship** ([results](design/iter-e400-e402-component-plan-balance-20260718.md)) |
| E403 mild balance protocol rejection | `e403-component-plan-mild-continuation-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e403-component-plan-mild-continuation-r1/checkpoints/last.pt` (local) | 29,066 target tokens in 107.8s, but slot-wide prompt context accidentally differs from E396/E400; not evaluated — **protocol-invalid, not ship** ([results](design/iter-e403-e406-mild-component-plan-balance-20260718.md)) |
| E404 controlled mild balance rejection | `e404-component-plan-mild-controlled-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e404-component-plan-mild-controlled-r1/checkpoints/last.pt` (local) | 29,066 target tokens in 108.7s; reduced balance ratio to 3.54× but repeated smoke meaningful/recall collapse and AgentV 3/4 — **rejected, not ship** ([results](design/iter-e403-e406-mild-component-plan-balance-20260718.md)) |
...
| E419 three-step continuation rejection | `e419-component-plan-three-step-control-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e419-component-plan-three-step-control-r1/checkpoints/last.pt` (local) | Three resumed steps / 22,197 tokens; smoke recall 0.3333 narrowly misses its floor — **rejected, not ship** ([results](design/iter-e419-e420-three-step-boundary-20260718.md)) |
| E421 two-step continuation control | `e421-component-plan-two-step-control-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e421-component-plan-two-step-control-r1/checkpoints/last.pt` (local) | Two resumed steps / 22,127 tokens; bounded AgentV 4/4, establishing step 430 as the first failure — **control only, not ship** ([results](design/iter-e421-e422-exact-step-boundary-20260718.md)) |
| E423 low-LR continuation rejection | `e423-component-plan-23k-low-lr-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e423-component-plan-23k-low-lr-r1/checkpoints/last.pt` (local) | Effective LR `3e-5`; bounded AgentV 4/4 and fresh NLL 5.2778, but matched RICO-48 structure/recall regress to 0.6170/0.7326 — **rejected, not ship** ([results](design/iter-e423-e425-low-lr-continuation-20260718.md)) |
| E431 auxiliary-only continuation rejection | `e431-component-plan-23k-aux-only-r1` | CPU frozen SmolLM2 auxiliary-head continuation | `outputs/runs/e431-component-plan-23k-aux-only-r1/checkpoints/last.pt` (local) | Zero base tensors changed and bounded AgentV 4/4, but matched RICO-48 structure/recall regress to 0.6211/0.6007 — **rejected, not ship** ([results](design/iter-e431-e433-auxiliary-only-continuation-20260718.md)) |
| E434 low-LR auxiliary-only protocol rejection | `e434-component-plan-23k-aux-only-low-lr-r1` | CPU frozen SmolLM2 auxiliary-head continuation | `outputs/runs/e434-component-plan-23k-aux-only-low-lr-r1/checkpoints/last.pt` (local) | Slot prompt context and lexeme prior drifted from the control — **protocol-invalid, not evaluated or ship** ([results](design/iter-e434-e437-auxiliary-only-low-lr-20260718.md)) |
| E435 controlled low-LR auxiliary-only rejection | `e435-component-plan-23k-aux-only-low-lr-controlled-r1` | CPU frozen SmolLM2 auxiliary-head continuation | `outputs/runs/e435-component-plan-23k-aux-only-low-lr-controlled-r1/checkpoints/last.pt` (local) | Zero base drift and bounded AgentV 4/4, but matched RICO-48 structure/recall 0.6386/0.8889 remain below E396 — **rejected, not ship** ([results](design/iter-e434-e437-auxiliary-only-low-lr-20260718.md)) |
| E438 `1e-5` auxiliary-only rejection | `e438-component-plan-23k-aux-only-lr1e5-r1` | CPU frozen SmolLM2 auxiliary-head continuation | `outputs/runs/e438-component-plan-23k-aux-only-lr1e5-r1/checkpoints/last.pt` (local) | All bounded/RICO predictions duplicate E435 and matched RICO remains below E396 — **rejected, not ship** ([results](design/iter-e438-e440-auxiliary-only-lr1e5-20260718.md)) |
...
| `smoke` (E322 focal slot owner) | 3 | 1.0 | 1.0000 | 0.5464 | 0.6407 | No — component recall 0.3333 < 0.35 |
| `held_out` (E322 focal slot owner) | 5 | 1.0 | 1.0000 | 0.4011 | 0.1994 | No — meaningful 0.20 and component recall 0.10 |
| `adversarial` (E322 focal slot owner) | 4 | 1.0 | 1.0000 | 0.5970 | 0.4805 | Yes for suite thresholds; no global ship |
| `ood` (E322 focal slot owner) | 4 | 1.0 | 1.0000 | 0.4304 | 0.4992 | Yes for suite thresholds; no global ship |
| `rico_held` (E322 focal slot owner) | 3 | 1.0 | 1.0000 | 0.3850 | 1.0000 | Yes for limited suite thresholds; no global ship |
| `smoke` (E323 balanced slot owner) | 3 | 1.0 | 1.0000 | 0.5464 | 0.6407 | No — component recall 0.3333 < 0.35 |
| `held_out` (E323 balanced slot owner) | 5 | 1.0 | 1.0000 | 0.4155 | 0.1994 | No — meaningful 0.20 and component recall 0.10 |
| `adversarial` (E323 balanced slot owner) | 4 | 1.0 | 1.0000 | 0.5970 | 0.4805 | Yes for suite thresholds; no global ship |
| `ood` (E323 balanced slot owner) | 4 | 1.0 | 1.0000 | 0.4304 | 0.4992 | Yes for suite thresholds; no global ship |
| `rico_held` (E323 balanced slot owner) | 3 | 1.0 | 1.0000 | 0.3676 | 1.0000 | Yes for limited suite thresholds; no global ship |
| `smoke` (E324 next-slot context) | 3 | 1.0 | 1.0000 | 0.5464 | 0.6407 | No — component recall 0.3333 < 0.35 |
| `held_out` (E324 next-slot context) | 5 | 1.0 | 1.0000 | 0.4155 | 0.1994 | No — meaningful 0.20 and component recall 0.10 |
...
| `smoke` (E326 lexeme slot prior) | 3 | 1.0 | 1.0000 | 0.5464 | 0.6407 | No — component recall 0.3333 < 0.35 |
| `held_out` (E326 lexeme slot prior) | 5 | 1.0 | 1.0000 | 0.5458 | 0.5862 | Yes for suite thresholds; no global ship |
...
| `smoke` (E330 prompt-conditioned lexeme) | 3 | 1.0 | 1.0000 | 0.5464 | 0.6407 | No — component recall 0.3333 < 0.35 |
| `held_out` (E330 prompt-conditioned lexeme) | 5 | 1.0 | 1.0000 | 0.4708 | 0.5862 | Yes at recall floor; no global ship |
| `adversarial` (E330 prompt-conditioned lexeme) | 4 | 1.0 | 1.0000 | 0.6304 | 0.7238 | Yes for suite thresholds; no global ship |
| `ood` (E330 prompt-conditioned lexeme) | 4 | 1.0 | 1.0000 | 0.5229 | 0.9857 | Yes for suite thresholds; no global ship |
| `rico_held` (E330 prompt-conditioned lexeme) | 3 | 1.0 | 1.0000 | 0.4826 | 1.0000 | Yes for limited suite thresholds; no global ship |
| `smoke` (E333 scratch champion) | 3 | 1.0 | 1.0000 | 0.6281 | 0.6407 | Yes for scratch thresholds; not production ship |
| `held_out` (E333 scratch champion) | 5 | 1.0 | 1.0000 | 0.5451 | 0.5862 | Yes for scratch thresholds; not production ship |
...
| `smoke` (E336 frozen HF context) | 3 | 1.0 | 0.6111 | 0.4072 | 0.0 | No — meaningful/recall/reward 0.0 |
| `held_out` (E336 frozen HF context) | 5 | 1.0 | 0.2233 | 0.2379 | 0.0 | No — meaningful/recall/reward 0.0 |
| `adversarial` (E336 frozen HF context) | 4 | 1.0 | 0.2292 | 0.2899 | 0.0 | No — meaningful/recall/reward 0.0 |
| `ood` (E336 frozen HF context) | 4 | 1.0 | 0.5917 | 0.2133 | 0.2268 | No — meaningful 0.25 / recall 0.125 |
| `rico_held` (E336 frozen HF context) | 0 | — | — | — | — | Not completed — evaluation interrupted on five-minute cap |
| `smoke` (E337 frozen HF context 30k) | 3 | 0.6667 | 0.0 | 0.2511 | 0.0 | No — bounded suite; AgentV fail |
...
| `smoke` (E344 low-LR visible-slot) | 3 | 1.0 | 0.1111 | 0.3150 | 0.0 | No — exactly E343 quality |
...
| `rico_held` (E368/E375 structural diagnostic) | 16 | 1.0 | 0.9896 | 0.6619 | 0.9965 | No — strong diagnostic, but only 16/1500; AgentV 0/1 |
| `rico_held` (E368/E377 structural shard) | 64 | 1.0 | 0.9922 | 0.6695 | 0.9971 | No — strong partial evidence, but only 64/1500; AgentV 0/1 |
| `rico_held` (E368/E379 structural merge) | 128 | 1.0 | 0.9915 | 0.6602 | 0.9961 | No — strong contiguous partial evidence, but only 128/1500 |
| `rico_held` (E368/E381 capacity-fixed shard) | 64 | 1.0 | 0.9896 | 0.6191 | 0.9945 | No — zero failures after capacity fix, but only rows 128–192 |
| `rico_held` (E368/E382 structural merge) | 192 | 1.0 | 0.9909 | 0.6465 | 0.9956 | No — strong contiguous partial evidence, but only 192/1500 |
| `rico_held` (E368/E383 capacity-safe shard) | 48 | 1.0 | 0.9878 | 0.6253 | 0.9939 | No — zero failures, but only rows 192–240 |
| `rico_held` (E368/E384 structural merge) | 240 | 1.0 | 0.9903 | 0.6422 | 0.9952 | No — strong contiguous partial evidence, but only 240/1500 |
| `rico_held` (E368/E385 capacity-safe shard) | 48 | 1.0 | 0.9913 | 0.6170 | 0.9954 | No — zero failures, but only rows 240–288 |
| `rico_held` (E368/E386 structural merge) | 288 | 1.0 | 0.9905 | 0.6380 | 0.9953 | No — strong contiguous partial evidence, but only 288/1500 |
| `rico_held` (E368/E387 capacity-safe shard) | 48 | 1.0 | 0.9826 | 0.6278 | 0.9929 | No — zero failures, but only rows 288–336 |
| `rico_held` (E368/E388 structural merge) | 336 | 1.0 | 0.9893 | 0.6366 | 0.9949 | Invalidated — actual choice canvas was 58 despite reported 320 |
| `rico_held` (E368/E392 effective-canvas shard) | 48 | 1.0 | 1.0 | 0.6514 | 0.9994 | No — corrected 256-token policy, but only rows 336–384 |
| `smoke` (E368/E393 effective-canvas policy) | 3 | 1.0 | 1.0 | 0.5350 | 0.9770 | Yes for bounded suite; no global ship |
| `held_out` (E368/E393 effective-canvas policy) | 5 | 0.4 | 1.0 | 0.5061 | 0.3922 | No — component recall 0.2333 below 0.30 |
| `adversarial` (E368/E393 effective-canvas policy) | 4 | 1.0 | 1.0 | 0.7277 | 0.9790 | Yes for bounded suite; no global ship |
| `ood` (E368/E393 effective-canvas policy) | 4 | 1.0 | 1.0 | 0.5377 | 0.9865 | Yes for bounded suite; no global ship |
| `smoke` (E396/E490 full gates) | 3 | 1.0 | 1.0 | 0.6822 | 0.9730 | Yes; meaningful 1.0, recall 0.6667 |
| `held_out` (E396/E490 full gates) | 5 | 1.0 | 1.0 | 0.7838 | 0.9868 | Yes; meaningful 1.0, recall 0.9048 |
| `adversarial` (E396/E490 full gates) | 4 | 1.0 | 1.0 | 0.8061 | 0.9767 | Yes; meaningful/recall 1.0 |
| `ood` (E396/E490 full gates) | 4 | 1.0 | 1.0 | 0.6343 | 0.9865 | Yes; meaningful 1.0, recall 0.8750 |
| `rico_held` (E396/E488/E490 full gates) | 1500 | 1.0 | 1.0 | 0.8737 | 0.9939 | Yes; meaningful/recall 1.0, zero recorded failures |
| `smoke` (E400/E402 component-plan balance) | 3 | 1.0 | 1.0 | 0.5114 | 0.3163 | No — meaningful 0.3333 and recall 0.1667 |
| `held_out` (E400/E402 component-plan balance) | 5 | 1.0 | 1.0 | 0.5217 | 0.7814 | Yes for bounded suite; global checkpoint rejected |
| `adversarial` (E400/E402 component-plan balance) | 4 | 1.0 | 1.0 | 0.5137 | 0.4865 | Yes for bounded suite; global checkpoint rejected |
| `ood` (E400/E402 component-plan balance) | 4 | 0.75 | 0.75 | 0.4652 | 0.4835 | Yes for thresholds; parse/fidelity regress vs E396 |
| `smoke` (E404/E406 mild component-plan balance) | 3 | 1.0 | 1.0 | 0.5114 | 0.3163 | No — meaningful 0.3333 and recall 0.1667 |
| `held_out` (E404/E406 mild component-plan balance) | 5 | 1.0 | 1.0 | 0.5161 | 0.7814 | Yes for bounded suite; recall 0.4333 and global checkpoint rejected |
| `adversarial` (E404/E406 mild component-plan balance) | 4 | 1.0 | 1.0 | 0.6304 | 0.7238 | Yes for bounded suite; global checkpoint rejected |
| `ood` (E404/E406 mild component-plan balance) | 4 | 0.75 | 0.75 | 0.4652 | 0.4835 | Yes for thresholds; parse/fidelity regress vs E396 |
| `smoke` (E407/E408 unbalanced continuation control) | 3 | 1.0 | 1.0 | 0.5114 | 0.3163 | No — exactly matches balanced continuation collapse |
| `held_out` (E407/E408 unbalanced continuation control) | 5 | 1.0 | 1.0 | 0.5161 | 0.7814 | Yes for bounded suite; global checkpoint rejected |
| `adversarial` (E407/E408 unbalanced continuation control) | 4 | 1.0 | 1.0 | 0.6304 | 0.7238 | Yes for bounded suite; global checkpoint rejected |
| `ood` (E407/E408 unbalanced continuation control) | 4 | 0.75 | 0.75 | 0.2846 | 0.2432 | Yes for thresholds; materially worse than mild balance and E396 |
| `smoke` (E409/E410 25k continuation boundary) | 3 | 1.0 | 1.0 | 0.4242 | 0.3243 | No — meaningful 0.3333 and recall 0.1667 |
| `held_out` (E409/E410 25k continuation boundary) | 5 | 1.0 | 1.0 | 0.5488 | 0.7808 | Yes for bounded suite; global checkpoint rejected |
| `adversarial` (E409/E410 25k continuation boundary) | 4 | 1.0 | 1.0 | 0.5970 | 0.4805 | Yes for bounded suite; global checkpoint rejected |
| `ood` (E409/E410 25k continuation boundary) | 4 | 1.0 | 1.0 | 0.5680 | 0.7335 | Yes for bounded suite; global checkpoint rejected |
| `smoke` (E411/E412 23k continuation boundary) | 3 | 1.0 | 1.0 | 0.4975 | 0.3203 | No — meaningful 0.3333 and recall 0.1667 |
...
| `smoke` (E415/E416 ten-step continuation) | 3 | 1.0 | 1.0 | 0.4975 | 0.3203 | No — meaningful 0.3333 and recall 0.1667 |
...
| `smoke` (E419/E420 three-step continuation) | 3 | 1.0 | 1.0 | 0.4628 | 0.6607 | No — recall 0.3333 below 0.35 |
| `held_out` (E419/E420 three-step continuation) | 5 | 1.0 | 1.0 | 0.6633 | 0.7814 | Yes for bounded suite; recall 0.5833 |
| `adversarial` (E419/E420 three-step continuation) | 4 | 1.0 | 1.0 | 0.6304 | 0.7238 | Yes for bounded suite; full RICO missing |
| `ood` (E419/E420 three-step continuation) | 4 | 1.0 | 1.0 | 0.5352 | 0.7335 | Yes for bounded suite; full RICO missing |
| `smoke` (E421/E422 two-step continuation) | 3 | 1.0 | 1.0 | 0.5600 | 0.9770 | Yes for bounded suite; full RICO missing |
| `held_out` (E421/E422 two-step continuation) | 5 | 1.0 | 1.0 | 0.5933 | 0.5916 | Yes for bounded suite; recall 0.4833 |
| `adversarial` (E421/E422 two-step continuation) | 4 | 1.0 | 1.0 | 0.6304 | 0.7238 | Yes for bounded suite; full RICO missing |
| `ood` (E421/E422 two-step continuation) | 4 | 1.0 | 1.0 | 0.5352 | 0.7335 | Yes for bounded suite; full RICO missing |
| `smoke` (E423/E425 low-LR 23k continuation) | 3 | 1.0 | 1.0 | 0.5600 | 0.9770 | Yes for bounded suite; recall 0.5000, full RICO missing |
| `held_out` (E423/E425 low-LR 23k continuation) | 5 | 1.0 | 1.0 | 0.6633 | 0.7814 | Yes for bounded suite; recall 0.5833 |
...
| `smoke` (E431/E432 auxiliary-only continuation) | 3 | 1.0 | 1.0 | 0.5600 | 0.9770 | Yes for bounded suite; recall 0.5000, full RICO missing |
| `held_out` (E431/E432 auxiliary-only continuation) | 5 | 1.0 | 1.0 | 0.5933 | 0.5916 | Yes for bounded suite; meaningful 0.6000 and recall 0.4833 |
| `adversarial` (E431/E432 auxiliary-only continuation) | 4 | 1.0 | 1.0 | 0.6304 | 0.7238 | Yes for bounded suite; full RICO missing |
| `ood` (E431/E432 auxiliary-only continuation) | 4 | 1.0 | 1.0 | 0.5511 | 0.9828 | Yes for bounded suite; meaningful 1.0 and recall 0.7292 |
| `rico_held` (E431/E433 rows 336–384) | 48/1500 | 1.0 | 1.0 | 0.6211 | 0.9768 | Diagnostic subset only; meaningful 0.9792 and recall 0.6007 regress E396 |
| `smoke` (E435/E436 low-LR auxiliary-only) | 3 | 1.0 | 1.0 | 0.5600 | 0.9770 | Yes for bounded suite; recall 0.5000, full RICO missing |
| `held_out` (E435/E436 low-LR auxiliary-only) | 5 | 1.0 | 1.0 | 0.5933 | 0.5916 | Yes for bounded suite; meaningful 0.6000 and recall 0.4833 |
| `adversarial` (E435/E436 low-LR auxiliary-only) | 4 | 1.0 | 1.0 | 0.6762 | 0.7268 | Yes for bounded suite; recall 0.7500 |
| `ood` (E435/E436 low-LR auxiliary-only) | 4 | 1.0 | 1.0 | 0.5511 | 0.9828 | Yes for bounded suite; meaningful 1.0 and recall 0.7292 |
| `rico_held` (E435/E437 rows 336–384) | 48/1500 | 1.0 | 1.0 | 0.6386 | 0.9991 | Diagnostic subset only; meaningful 1.0 and recall 0.8889 remain below E396 |
| `smoke` (E438/E439 LR `1e-5` auxiliary-only) | 3 | 1.0 | 1.0 | 0.5600 | 0.9770 | Yes for bounded suite; prediction-identical to E435 |
| `held_out` (E438/E439 LR `1e-5` auxiliary-only) | 5 | 1.0 | 1.0 | 0.5933 | 0.5916 | Yes for bounded suite; prediction-identical to E435 |
| `adversarial` (E438/E439 LR `1e-5` auxiliary-only) | 4 | 1.0 | 1.0 | 0.6762 | 0.7268 | Yes for bounded suite; prediction-identical to E435 |
| `ood` (E438/E439 LR `1e-5` auxiliary-only) | 4 | 1.0 | 1.0 | 0.5511 | 0.9828 | Yes for bounded suite; prediction-identical to E435 |
| `rico_held` (E438/E440 rows 336–384) | 48/1500 | 1.0 | 1.0 | 0.6386 | 0.9991 | Diagnostic subset only; prediction-identical to E435 and recall 0.8889 below E396 |
...
| `ood` (E368/E376 structural policy) | 4 | 1.0 | 1.0 | 0.5114 | 0.9865 | Yes for bounded suite; no global ship |
...
| 2026-07-17 | `e368-card-hierarchy-adapt-18k-local-r1` (E368 bounded continuation) | `outputs/runs/e368-card-hierarchy-adapt-18k-local-r1/` (local) | Full-state resume from E360; 293 cumulative CPU steps / 15,091 target tokens; stopped on 4.5-minute wall budget at 270.4s; last-checkpoint SHA `a7dd2d79df0c3c36f80e1bb81349f7dad663d9796d201ffff492535a11982573`; inherited best NLL 5.8091; explicit no-sync | Corrected 256-token E393 bounded AgentV 3/4; E392 RICO-48 fidelity 1.0 / structure 0.6514. Earlier E376–E390 selection evidence invalidated by actual 58-token canvas; no promotion |
| 2026-07-18 | `e396-balanced-type-head-continuation-r1` (E396 balanced type supervision) | `outputs/runs/e396-balanced-type-head-continuation-r1/` (local) | Full-state resume from E368 on unchanged E357 corpus; component-plan loss 4, slot balance power 0.5; 427 cumulative CPU steps / 22,044 target tokens in 104.6s; SHA `feefa0564490bd1db42f79ff710143ad8ed07ab9e4e324f2744a30f8c2f2eee0`; inherited best NLL 5.8091; explicit no-sync | Bounded AgentV 4/4 and held recall 0.4833; matched RICO-48 structure/recall 0.6401/0.8993; full RICO absent, no promotion |
| 2026-07-18 | `e396-balanced-type-head-continuation-r1` (E442 local ship-gate promotion) | `outputs/runs/e396-balanced-type-head-continuation-r1/` (local) | Unchanged E396 SHA; E398 bounded suites plus E441 canonical full RICO n=1500; CPU/local-only honest policy; AgentV 5/5 | All five authoritative ship gates pass with no failures; promoted to local ship-gate champion, while production HF ship remains pending bucket sync |
| 2026-07-18 | `e396-balanced-type-head-continuation-r1` (E456 repaired-corpus gate refresh) | `outputs/runs/e396-balanced-type-head-continuation-r1/` (local) | Unchanged E396 SHA; E455 bounded suites plus E454 repaired full RICO n=1500; prompt-role constrained decode; AgentV 5/5 | All five authoritative gates pass; full RICO meaningful/fidelity 1.0, structure/recall 0.8683/0.9960; remains local pending bucket sync |
| 2026-07-18 | `e396-balanced-type-head-continuation-r1` (E462 semantic-slot gate refresh) | `outputs/runs/e396-balanced-type-head-continuation-r1/` (local) | Unchanged E396 SHA; E461 bounded suites plus E460 exact full RICO n=1500; semantic-slot decoder and corrected reward evaluator; AgentV 5/5 | All five authoritative local gates pass; full RICO meaningful/fidelity/recall 1.0 and structure 0.8740; remains local pending bucket sync |
| 2026-07-18 | `e396-balanced-type-head-continuation-r1` (E465 explicit-Callout gate refresh) | `outputs/runs/e396-balanced-type-head-continuation-r1/` (local) | Unchanged E396 SHA; E464 bounded suites plus unaffected E460 full RICO n=1500 after zero-match impact audit; AgentV 5/5 | All five authoritative local gates pass; smoke structure/recall improve to 0.6822/0.6667; remains local pending bucket sync |
| 2026-07-18 | `e396-balanced-type-head-continuation-r1` (E468 reference-array gate refresh) | `outputs/runs/e396-balanced-type-head-continuation-r1/` (local) | Unchanged E396 SHA; E467 bounded suites plus unaffected E460 full RICO n=1500 after prediction-level zero-impact audit; AgentV 5/5 | All five authoritative local gates pass; OOD structure/recall improve to 0.6279/0.8750; remains local pending bucket sync |
| 2026-07-18 | `e396-balanced-type-head-continuation-r1` (E474 schema-enum gate refresh) | `outputs/runs/e396-balanced-type-head-continuation-r1/` (local) | Unchanged E396 SHA; E470–E471 fresh bounded suites plus E473 exact full RICO n=1500; schema-valid enum decode; AgentV 5/5 | All five authoritative local gates pass with zero failures/fallback/timeouts; remains local pending bucket sync |
| 2026-07-18 | `e396-balanced-type-head-continuation-r1` (E479 schema-array item gate refresh) | `outputs/runs/e396-balanced-type-head-continuation-r1/` (local) | Unchanged E396 SHA; E476 fresh bounded suites plus E478 exact full RICO n=1500; schema-valid array-item decode; AgentV 5/5 | All five authoritative local gates pass with zero failures/fallback/timeouts; OOD structure improves to 0.6343; remains local pending bucket sync |
| 2026-07-18 | `e396-balanced-type-head-continuation-r1` (E490 JSON-number/typed-any gate refresh and bucket sync) | `hf://buckets/TKendrick/OpenUI/checkpoints/e396-balanced-type-head-continuation-r1` | Unchanged E396 SHA; E489 fresh bounded suites plus E488 exact full RICO n=1500; JSON-number-frame and typed-any constrained decode; AgentV 5/5 | All five current-policy gates pass with zero failures/fallback/timeouts; full-RICO structure 0.8737; durable HF checkpoint confirmed, serving promotion unchanged |
| 2026-07-18 | `e400-component-plan-balanced-continuation-r1` (E400 component-plan balance) | `outputs/runs/e400-component-plan-balanced-continuation-r1/` (local) | Full-state resume from E396 on unchanged E357 corpus; component-plan balance power 0.5; 567 cumulative CPU steps / 29,066 target tokens in 106.8s; SHA `e62f0859172072a1567e38876a93a6aa76b2dbeaaa1a59d726fe6b779a230aad`; inherited best NLL 5.8091; explicit no-sync | Settings row improves, but smoke meaningful/recall regress to 0.3333/0.1667; AgentV 3/4, rejected |
| 2026-07-18 | `e403-component-plan-mild-continuation-r1` (E403 protocol rejection) | `outputs/runs/e403-component-plan-mild-continuation-r1/` (local) | Full-state resume from E396; balance power 0.25; 567 cumulative CPU steps / 29,066 target tokens in 107.8s; SHA `bf0ca0f8fd14d6d6fad301d4fe82063c358f79eec749901276ae338204f5344e`; explicit no-sync | Slot-wide prompt context accidentally enabled; protocol-invalid, not evaluated or promoted |
| 2026-07-18 | `e404-component-plan-mild-controlled-r1` (E404 controlled mild balance) | `outputs/runs/e404-component-plan-mild-controlled-r1/` (local) | Full-state resume from E396; balance power 0.25 with prompt context explicitly disabled; 567 cumulative CPU steps / 29,066 target tokens in 108.7s; SHA `fee1fdfe3f83c711161ee259951b4a7917ce3e968463235ce03f380577ea6219`; inherited best NLL 5.8091; explicit no-sync | Bounded AgentV 3/4; smoke repeats E400 collapse; rejected, no RICO or promotion |
...
| 2026-07-18 | `e419-component-plan-three-step-control-r1` (E419 three-step boundary) | `outputs/runs/e419-component-plan-three-step-control-r1/` (local) | Full-state resume from E396; balance power zero; 430 cumulative CPU steps / 22,197 target tokens in 9.4s; SHA `0b3c3bc7d04d5ffdbb477b0f8e2c36882399e7e1bd8bfbf8a3138c47cb542093`; inherited best NLL 5.8091; explicit no-sync | Smoke recall 0.3333 narrowly fails; rejected |
| 2026-07-18 | `e421-component-plan-two-step-control-r1` (E421 exact boundary) | `outputs/runs/e421-component-plan-two-step-control-r1/` (local) | Full-state resume from E396; balance power zero; 429 cumulative CPU steps / 22,127 target tokens in 8.2s; SHA `81d5db009a9ab1d56337886713d54075522cf6000b8f63fdf83c77bac51e1940`; inherited best NLL 5.8091; explicit no-sync | Bounded AgentV 4/4; exact safe side of step-430 failure; control only |
| 2026-07-18 | `e423-component-plan-23k-low-lr-r1` (E423 effective low-LR continuation) | `outputs/runs/e423-component-plan-23k-low-lr-r1/` (local) | Full-state resume from E396 after fixing LR override; all AdamW groups at `3e-5`; 446 cumulative CPU steps / 23,019 target tokens in 21.6s; SHA `2a6b84ba7259937bbaf1e3edb712f2adde4ce8cdef0be6cbcc55e7ffa260e3ad`; E426 fresh complete weighted NLL 5.2778; explicit no-sync | Bounded AgentV 4/4, but E427 matched RICO-48 structure/recall regress to 0.6170/0.7326; rejected, no full RICO or promotion |
| 2026-07-18 | `e431-component-plan-23k-aux-only-r1` (E431 auxiliary-only continuation) | `outputs/runs/e431-component-plan-23k-aux-only-r1/` (local) | Full-state resume from E396; only plan/slot auxiliary heads train at `3e-4`; zero base tensors and four auxiliary tensors changed; 446 cumulative CPU steps / 23,019 target tokens in 20.6s; SHA `be66555fe473b50eb17a76654ca9f12ddf5ae433f5d743d60eda3ff47c541ab3`; inherited best NLL 5.8091; explicit no-sync | Bounded AgentV 4/4, but E433 matched RICO-48 structure/recall regress to 0.6211/0.6007; rejected, no full RICO or promotion |
| 2026-07-18 | `e434-component-plan-23k-aux-only-low-lr-r1` (E434 protocol rejection) | `outputs/runs/e434-component-plan-23k-aux-only-low-lr-r1/` (local) | Auxiliary-only E396 resume at `3e-5`; 446 cumulative CPU steps / 23,019 target tokens in 23.3s; SHA `4fc7ed3205f1730d780ecdcda7e4bb7039208b571151b4c2c15fbe54062c6508`; explicit no-sync | Slot prompt context and lexeme prior differ from E396/E431; protocol-invalid, not evaluated or promoted |
| 2026-07-18 | `e435-component-plan-23k-aux-only-low-lr-controlled-r1` (E435 controlled low-LR auxiliary-only) | `outputs/runs/e435-component-plan-23k-aux-only-low-lr-controlled-r1/` (local) | Controlled auxiliary-only E396 resume at `3e-5`; zero base tensors and four auxiliary tensors changed; 446 cumulative CPU steps / 23,019 target tokens in 21.4s; SHA `d912bceeb5aeea1af53dafeea7de626d1be092a8e02952d4b7500101c3372c55`; inherited best NLL 5.8091; explicit no-sync | Bounded AgentV 4/4, but E437 matched RICO-48 structure/recall 0.6386/0.8889 remain below E396; rejected, no full RICO or promotion |
| 2026-07-18 | `e438-component-plan-23k-aux-only-lr1e5-r1` (E438 LR `1e-5` auxiliary-only) | `outputs/runs/e438-component-plan-23k-aux-only-lr1e5-r1/` (local) | Controlled auxiliary-only E396 resume at `1e-5`; zero base tensors and four auxiliary tensors changed; 446 cumulative CPU steps / 23,019 target tokens in 21.2s; SHA `eebb6d31645bf49643c5887085c735b810357b06eea49dad244ef90a5f622bff`; inherited best NLL 5.8091; explicit no-sync | All bounded and RICO predictions duplicate E435; matched RICO remains below E396; rejected, no full RICO or promotion |

...
| --- | --- | --- | --- | --- |
| 2026-07-22 | `e877-e852-hard80-warm20-r1` | `outputs/runs/e877-e852-hard80-warm20-r1/` (local) | Smoke n=3 parse 1.0 / meaning-v1 0.6667 / strict-v2 0 / fidelity 0.9167 / structure 0.4625 / recall 0.3333 / reward 0.9360, AgentV 0/1 | Warm-start vocabulary remap completed 20/20 CPU steps in 52.71s; explicit no-sync scratch diagnostic; regressed E865 and rejected |

...
| --- | --- | --- | --- | --- |
| 2026-07-23 | `e1069_v271_331_step_control` | `outputs/runs/e1069_v271_331_step_control/` (local) | Exact 331-step control complete; strict smoke pending | 100.92 cumulative train seconds after own full-state resume, SHA `79d3f93d...8f5617`; no comparison before evaluation |

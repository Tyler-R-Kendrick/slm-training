...
| --- | --- | --- | --- | --- |
| E951 role-safe warm-start diagnostic | `e951-e891-role-safe-warm20-r1` | CPU scratch role-safe continuation diagnostic | `outputs/runs/e951-e891-role-safe-warm20-r1/checkpoints/last.pt` (local) | 20 steps / 2.91s, SHA `1646f0b6…905e4b`; E956 held-out n=5 parse 1.0 / meaning-v1 0.8 / strict-v2 0.6 / fidelity 0.8333 / structure 0.4434 / recall 0.6952 / zero timeouts and role violations, AgentV 0/2 — **decoder treatment retained; checkpoint never sync/promote/serve/use as parent because E891 predates role safety** ([results](design/iter-e939-e952-role-safe-decoding-20260722.md)) |
...
| --- | --- | --- | --- | --- |
| 2026-07-23 | `e951-e891-role-safe-warm20-r1` | `outputs/runs/e951-e891-role-safe-warm20-r1/` (local) | E956 held-out n=5 parse 1.0 / meaning-v1 0.8 / strict-v2 0.6 / fidelity 0.8333 / structure 0.4434 / recall 0.6952, zero timeouts/role violations, AgentV 0/2 | Schema typing improves strict topology but needs three certified fallbacks; weights inherit pre-role-safe E891; explicit no-sync diagnostic, never promote or use as parent |

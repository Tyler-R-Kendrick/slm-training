...
| E396 local ship-gate champion | `e396-balanced-type-head-continuation-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e396-balanced-type-head-continuation-r1/checkpoints/last.pt` (local) | E479 current-policy five-suite gates pass with no failures and AgentV 5/5; smoke structure/recall 0.6822/0.6667, OOD 0.6343/0.8750, and full RICO n=1500 meaningful/fidelity/recall 1.0 with structure 0.8736. **Local champion; production HF ship pending durable bucket sync** ([train](design/iter-e396-e399-balanced-type-supervision-20260718.md), [full gates](design/iter-e479-e396-array-items-full-ship-gates-20260718.md)) |
...
| `smoke` (E396/E479 full gates) | 3 | 1.0 | 1.0 | 0.6822 | 0.9730 | Yes; meaningful 1.0, recall 0.6667 |
| `held_out` (E396/E479 full gates) | 5 | 1.0 | 1.0 | 0.7838 | 0.9868 | Yes; meaningful 1.0, recall 0.9048 |
| `adversarial` (E396/E479 full gates) | 4 | 1.0 | 1.0 | 0.8061 | 0.9767 | Yes; meaningful/recall 1.0 |
| `ood` (E396/E479 full gates) | 4 | 1.0 | 1.0 | 0.6343 | 0.9865 | Yes; meaningful 1.0, recall 0.8750 |
| `rico_held` (E396/E478/E479 full gates) | 1500 | 1.0 | 1.0 | 0.8736 | 0.9939 | Yes; meaningful/recall 1.0, zero recorded failures |

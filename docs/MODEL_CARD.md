...
| --- | --- | --- | --- | --- |
| R31 PR-head diagnostic control, pair incomplete | `science-lab-r31-43327120eda9-acceptance-control` | CPU scratch TwoTower; seed 7301, batch 2, six updates in chunks of three; 65,826 parameters; local no-sync | `outputs/autonomy-integration-20260921/science-lab-r31-43327120eda9-acceptance-prereg/campaigns/science-lab-r31-43327120eda9-acceptance/runs/science-lab-r31-43327120eda9-acceptance-control/checkpoints/trial/bundles/712026b16850c9077bfd5aad0b4ed3db2d92d0d658f4b87865263b9b9e94931f/last.pt` | Evaluation 0/6 completed at observation cutoff; candidate pending. **No paired result, promotion, or shipment.** [Measured continuation](design/science-lab-pr-head-r31-20260926-results.md) |
| R24 PR-head diagnostic pair, incomplete | `science-lab-pr1785-e9a6de-r24-20260925-{control,candidate}` | CPU scratch TwoTower; seed 7301, batch 2, six steps in three-step chunks; 65,826 parameters each; local no-sync | `outputs/autonomy-integration-20260921/science-lab-r24-e9a6de-prereg/campaigns/science-lab-pr1785-e9a6de-r24-20260925/runs/` | Control smoke 6/6 with AgentV; 11 ship-gate failures. Candidate trained six steps and wrote checkpoint; smoke eval timed out with exit 124 before terminal outcome. **No paired result, promotion, or shipment.** [Measured partial attempt](design/science-lab-pr-head-r24-20260925-results.md) |
| R23 PR-head diagnostic control, pair incomplete | `science-lab-pr1785-cf5432-r23-20260925-control` | CPU scratch TwoTower; seed 7301, batch 2, six steps in three-step chunks; 65,826 parameters; local no-sync | `outputs/autonomy-integration-20260921/science-lab-r23-cf5432-prereg/campaigns/science-lab-pr1785-cf5432-r23-20260925/runs/science-lab-pr1785-cf5432-r23-20260925-control/checkpoints/last.pt` | Smoke 6/6, AgentV complete; parse 1.0, MPR 1/6, structure 0.24445; 11 ship-gate failures. Candidate cursor started without run artifact. **No paired result, promotion, or shipment.** [Measured partial attempt](design/science-lab-pr-head-r23-20260925-results.md) |
| R22b PR-head diagnostic pair, incomplete | `science-lab-pr1785-0ea5ba4-r22b-20260925-{control,candidate}` | CPU scratch TwoTower; seed 7301, batch 2, six steps in three-step chunks, 65,826 parameters each; local no-sync | `outputs/autonomy-integration-20260921/science-lab-r22b-0ea5ba4-prereg/campaigns/science-lab-pr1785-0ea5ba4-r22b-20260925/runs/` | Control smoke 2/6; candidate 0/6. Controller emitted bare `--resume-run`; control exit 2. Paired `smoke.eval_nll` unavailable. **No promotion or ship claim.** [Measured failure](design/science-lab-pr-head-r22b-20260925-results.md) |
| SCI-LAB diagnostic pair and uninterrupted references | `science-lab-training-20260921` | CPU scratch TwoTower, 65,826 parameters each, seed 7301; logical six updates with exact resume after three | `outputs/autonomy-integration-20260921/science-lab-outputs/campaigns/science-lab-training-20260921/runs/` (local, no-sync) | Six public cases per arm; parse 1.0; meaningful-program rate 1/6; ship gates failed. **Exploratory; no promotion or shipment.** [Measured result](design/science-lab-training-20260921.md) |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| smoke (R31 PR-head diagnostic, control / candidate) | 0/6 / 0/6 completed | — / — | — / — | — / — | — / — | Not established: control trained six updates; pair incomplete ([details](design/science-lab-pr-head-r31-20260926-results.md)) |
| smoke (R23 PR-head diagnostic, control / candidate) | 6 / — | 1.0 / — | 0.916667 / — | 0.24445 / — | 0 / — | No — control MPR 0.166667, component recall 0.125, AST/canonical BEq 0; 11 ship-gate failures. Candidate not measured; paired NLL unavailable ([details](design/science-lab-pr-head-r23-20260925-results.md)) |
| smoke (R22b PR-head diagnostic, control / candidate) | 2/6 / 0/6 completed | 1.0 / — on decoded cases | — / — | 0.35 / — on decoded cases | 0 / — | No — incomplete measurement; control MPR 0.5 on 2 cases, candidate metrics unavailable; no paired NLL or ship gates ([details](design/science-lab-pr-head-r22b-20260925-results.md)) |
...
| --- | --- | --- | --- | --- |
| 2026-09-26 | `science-lab-r31-43327120eda9-acceptance-control` | Local scratch no-sync; checkpoint path in current roster | 65,826 params; six updates; SHA-256 `673fce9d06eee0b226d6520c1a8f32c9dacbc924ac8997d15a5e765df2b465b8` | Evaluation and pair incomplete; no promotion or shipment ([details](design/science-lab-pr-head-r31-20260926-results.md)) |
| 2026-09-25 | `science-lab-pr1785-e9a6de-r24-20260925-{control,candidate}` | Local no-sync; `outputs/autonomy-integration-20260921/science-lab-r24-e9a6de-prereg/campaigns/science-lab-pr1785-e9a6de-r24-20260925/runs/` | Both 65,826 params and six training steps; control smoke 6/6, parse 1.0, MPR .1667; candidate eval timed out before measurement completion | Control AgentV complete; ship gates fail 11. Candidate checkpoint retained; no paired result, promotion, or shipment ([details](design/science-lab-pr-head-r24-20260925-results.md)) |
| 2026-09-25 | `science-lab-pr1785-cf5432-r23-20260925-control` | Local no-sync; `outputs/autonomy-integration-20260921/science-lab-r23-cf5432-prereg/campaigns/science-lab-pr1785-cf5432-r23-20260925/runs/science-lab-pr1785-cf5432-r23-20260925-control/checkpoints/last.pt` | 65,826 params; six steps; smoke 6/6; SHA-256 `673fce9d06eee0b226d6520c1a8f32c9dacbc924ac8997d15a5e765df2b465b8` | AgentV complete, ship gates fail 11; candidate cursor started without run file. No paired result/promotion/ship ([details](design/science-lab-pr-head-r23-20260925-results.md)) |
| 2026-09-25 | `science-lab-pr1785-0ea5ba4-r22b-20260925-{control,candidate}` | Local no-sync; `outputs/autonomy-integration-20260921/science-lab-r22b-0ea5ba4-prereg/campaigns/science-lab-pr1785-0ea5ba4-r22b-20260925/runs/` | Both six-step, 65,826-parameter checkpoints; SHA-256 control `673fce9d06eee0b226d6520c1a8f32c9dacbc924ac8997d15a5e765df2b465b8`, candidate `0a125ff5e1ebcf4b456e8f0d432ca03a187eb298f045b77b8a13c81e62d27313` | Control decode 2/6, candidate 0/6; control continuation exit 2; no paired effect, promotion, or shipment ([details](design/science-lab-pr-head-r22b-20260925-results.md)) |
| 2026-09-21 | `science-lab-training-20260921` control/candidate + uninterrupted references | Local no-sync; `outputs/autonomy-integration-20260921/science-lab-outputs/campaigns/science-lab-training-20260921/runs/` | 65,826 parameters each; exact logical six-update continuation after a three-update prefix; six-case ordinary-supervisor comparison | Exploratory diagnostic only; no promotion; [details](design/science-lab-training-20260921.md) |
...
## Continuous autotrain note (2026-09-02, continuous-loop-20260902-climb-b-cad96bc5-c1)

- campaign: `continuous-loop-20260902-climb-b-cad96bc5-c1`
- checkpoints: `runs/c20260902-climb-b-cad96bc5-c1-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-09-02, continuous-loop-20260902-climb-c-7a4ba2f4-c1)

- campaign: `continuous-loop-20260902-climb-c-7a4ba2f4-c1`
- checkpoints: `runs/c20260902-climb-c-7a4ba2f4-c1-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-09-02, continuous-loop-20260902-recovery2-b552b74b-c1)
...
## SCI-LAB diagnostic checkpoints

Four local CPU scratch TwoTower checkpoints (continued control/candidate and
uninterrupted references), each with 65,826 parameters. Both arms used seed 7301
and six logical updates; exact continuation after the shared three-update prefix
matched its uninterrupted reference. The ordinary supervisor completed six
public evaluation cases per arm. Results and version stamp:
[measured result](design/science-lab-training-20260921.md).

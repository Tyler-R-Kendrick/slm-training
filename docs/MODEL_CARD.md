...
| E297 seed-1 DESIGN-dropout arm | `e297-choice-design-dropout50-seed1-r1` | CPU scratch 50% DESIGN-dropout replication | `outputs/runs/e297-choice-design-dropout50-seed1-r1/checkpoints/last.pt` (local) | Complete weighted NLL 7.5864; base eval meaningful 0.0/17 failures. E299 opt-in content floor cuts failures to 12 but regresses structure and AgentV remains 0/5 — **not promotable or ship** ([results](design/iter-e299-choice-min-content-20260717.md)) |

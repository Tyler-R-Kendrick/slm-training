...
| `smoke` (`e224-semantic-exhaustive-matched`, strict) | 3 | 0.0 | 0.0 | 0.3094 | 0.0 | No — 74.7% more AST-role rows, unchanged semantic zero |
| `held_out` (`e224-semantic-exhaustive-matched`, strict) | 5 | 0.0 | 0.0 | 0.2514 | 0.0 | No — strict gate failure |
| `adversarial` (`e224-semantic-exhaustive-matched`, strict) | 4 | 0.0 | 0.0 | 0.2905 | 0.0 | No — strict gate failure |
| `ood` (`e224-semantic-exhaustive-matched`, strict) | 4 | 0.0 | 0.0 | 0.2369 | 0.0 | No — strict gate failure |
| `rico_held` (`e224-semantic-exhaustive-matched`, strict) | 3 | 0.0 | 0.0 | 0.0901 | 0.0 | No — strict gate failure |
...
| 2026-07-16 | `e224-semantic-exhaustive-matched` (E224) | `outputs/autoresearch/e224-semantic-exhaustive-alignment/runs/e224-semantic-exhaustive-matched/` (local) | 32 CPU steps; loss 15.9786; AST-role rows 1,123 vs E223 643; strict scoreboard exactly unchanged | Per-state coverage hypothesis falsified; AgentV 0/5; checkpoint SHA `c9f38df1…22bb8ef`; no sync or promotion |

...
| E396 local ship-gate champion | `e396-balanced-type-head-continuation-r1` | CPU frozen SmolLM2 full-state continuation | `outputs/runs/e396-balanced-type-head-continuation-r1/checkpoints/last.pt` (local) | E456 repaired-corpus five-suite gates pass with no failures and AgentV 5/5; full RICO n=1500 has meaningful/fidelity 1.0 and structure/recall 0.8683/0.9960. **Local champion; production HF ship pending durable bucket sync** ([train](design/iter-e396-e399-balanced-type-supervision-20260718.md), [full gates](design/iter-e456-e396-repaired-full-ship-gates-20260718.md)) |
...
| `smoke` (E396/E456 full gates) | 3 | 1.0 | 1.0 | 0.5600 | 0.9770 | Yes; included in E456 five-suite pass |
| `held_out` (E396/E456 full gates) | 5 | 1.0 | 1.0 | 0.6400 | 0.5922 | Yes; meaningful 0.6, recall 0.5048 |
| `adversarial` (E396/E456 full gates) | 4 | 1.0 | 1.0 | 0.7661 | 0.9760 | Yes; meaningful/recall 1.0 |
| `ood` (E396/E456 full gates) | 4 | 1.0 | 1.0 | 0.5835 | 0.9835 | Yes; recall 0.8125 |
| `rico_held` (E396/E454–E456 full gates) | 1500 | 1.0 | 1.0 | 0.8683 | 0.9940 | Yes; meaningful 1.0, recall 0.9960, zero recorded failures |

...
| --- | --- | --- | --- | --- |
| E1066 dedicated root-arity scratch diagnostic | `e1066_v271_dedicated_root_arity` | CPU scratch role-safe dedicated root-reference arity diagnostic | `outputs/runs/e1066_v271_dedicated_root_arity/checkpoints/last.pt` (local) | 331 steps / 95.24s, SHA `51ffed4a...1b8ff22`; E1067 smoke parse 1.0 / strict-v2 0.6667 / fidelity 0.9167 / structure 0.6675 / recall 0.6667 / reward 0.9320, AgentV 0/1 — **rejected; never sync/promote/serve/resume/use as parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |
...
| --- | --- | --- | --- | --- |
| 2026-07-23 | `e1066_v271_dedicated_root_arity` | `outputs/runs/e1066_v271_dedicated_root_arity/` (local) | E1067 smoke parse 1.0 / strict-v2 0.6667 / fidelity 0.9167 / structure 0.6675 / recall 0.6667 / reward 0.9320, AgentV 0/1 | 331 fresh E937 steps in 95.24s, SHA `51ffed4a...1b8ff22`; explicit no-sync diagnostic, rejected and never use as parent |

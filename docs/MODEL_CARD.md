...
| --- | --- | --- | --- | --- |
| Autotrain c1732 component-plan promotion-cadence screen | `c20260801-continuous-openui-202607-98199209-c1732-{control,component-plan}` | CPU scratch TwoTower, `wf_smoke_v2`, lexer output, 23 steps, seed 101732, batch 2; both arms 1,755,764 trainable params with the component-plan head prebuilt | `outputs/autoresearch/continuous-loop-20260801-continuous-openui-202607-98199209-c1732/runs/` (local, explicit no-sync) | Exact quality ties on smoke n=3 (parse 1.0, meaningful .3333, structure .2153, binder F1 .8222) and held-out n=5 (parse 1.0, meaningful 0, structure .06024, binder F1 .7076). Treatment p50 is 2,066.56 vs 2,057.09 ms smoke and 1,665.84 vs 1,734.45 ms held-out, with 2.89× training wall. **Rejected; never reuse, promote, sync, or ship** ([results](design/autotrain-cycle-1732-component-plan-promotion-screen.md)) |
...
| --- | --- | --- | --- | --- |
| 2026-08-02 | `c20260801-continuous-openui-202607-98199209-c1732-{control,component-plan}` | `outputs/autoresearch/continuous-loop-20260801-continuous-openui-202607-98199209-c1732/runs/` (local, explicit no-sync) | Exact quality ties on smoke n=3 and held-out n=5; treatment p50 2,066.56 vs 2,057.09 ms smoke and 1,665.84 vs 1,734.45 ms held-out; AgentV complete, gates fail | Exactly matched 1,755,764-param arms. Control SHA `ea4f5f32…0046c27`; treatment SHA `bee24d60…7c2cc2e`. Third component-plan quality null; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1732-component-plan-promotion-screen.md)) |

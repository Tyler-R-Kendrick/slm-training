...
| E297 seed-1 DESIGN-dropout arm | `e297-choice-design-dropout50-seed1-r1` | CPU scratch 50% DESIGN-dropout replication | `outputs/runs/e297-choice-design-dropout50-seed1-r1/checkpoints/last.pt` (local) | Complete weighted NLL 7.5864; meaningful/component recall/reward 0.0 throughout, AgentV 0/5, 17 failures — **not promotable or ship** ([results](design/iter-e297-e298-dropout-replication-metric-guard-20260717.md)) |

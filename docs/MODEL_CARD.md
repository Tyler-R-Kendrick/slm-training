...
| Autotrain c1732 component-plan promotion-cadence screen | Control `c20260801-continuous-openui-202607-98199209-c1732-control`; treatment `c20260801-continuous-openui-202607-98199209-c1732-component-plan` | CPU scratch TwoTower, `wf_smoke_v2`, lexer output, 23 steps, seed 101732, batch 2, `honest_slot_contract=True`; both arms 1,755,764 trainable params with the component-plan head prebuilt | `outputs/autoresearch/continuous-loop-20260801-continuous-openui-202607-98199209-c1732/runs/` (local, explicit no-sync) | Control and treatment are exact quality ties on smoke n=3 (parse 1.0, meaningful .3333, structure .2153, binder F1 .8222) and held-out n=5 (parse 1.0, meaningful 0, structure .06024, binder F1 .7076). Treatment p50 is 2,066.56 vs 2,057.09 ms smoke and 1,665.84 vs 1,734.45 ms held-out, with 2.89× training wall. `--ship-gates` **fail** under `openui_ship_gates_v6`; run stamp `version_stamp/v1`, code `fbfc16ae6372cbccd9c8e1d30f755678ad6ffd19` clean, harness `v73`, meaning eval `2.13.0`, scoring `v22`, eval recipe `e938_role_safe_all_targets_v2`. **Rejected; never reuse, promote, sync, or ship** ([results](design/autotrain-cycle-1732-component-plan-promotion-screen.md)) |
...
| Autotrain c1708–c1710 infrastructure diagnostics | six `c20260801-continuous-openui-202607-98199209-c170{8,9,10}-*` runs | CPU scratch TwoTower, `wf_smoke_v2`, lexer output, 80–164 steps, batch 1–2, 1,608,962 trainable params | `outputs/autoresearch/continuous-loop-20260801-continuous-openui-202607-98199209-c170{8,9,10}/runs/` (local, explicit no-sync) | All six trains reached declared steps and wrote checkpoints; an 8 KiB stdout-tail parsing defect falsely stopped each outcome before evaluation. No suite metrics, AgentV bundle, or gate result exists—**infrastructure evidence only; never reuse, promote, or ship; frozen c1710 replay required** ([results](design/autotrain-cycles-1708-1710-runtime-artifact-recovery.md)) |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| smoke (c1848-binder-slot-ownership, control / candidate) | 3 / — | 1.0 / — | 0 / — | .05750 / — | 0 / — | No — candidate failed before training at capability validation; replay required; fixture n=3 |
| smoke (c1847-semantic-exhaustive, candidate / control) | 3 | 1.0 / 1.0 | .7222 / .9167 | .32250 / .23833 | .8657 / .9360 | No — MPR 0/0, binder .8222/.9524, AST/canonical 0/0; treatment cuts tokens 60/130, forwards 11/28, and p50 2811/6886 ms but regresses semantic quality; fixture n=3 |
| smoke (`c1846-exposure`, candidate / control) | 3 | 1.0 / 1.0 | 1.0 / .5278 | .41240 / .46417 | .9610 / .8073 | No — MPR `.6667/.3333`, recall `.4167/.25`, binder `1.0/.6333`, but candidate tokens `117/54`, forwards `25/10`, p50 `6358/2669` ms, AST/canonical `0` |
| smoke (`c1845-capacity-tail`, candidate / control) | 3 | 1.0 / 1.0 | .5278 / .5278 | .46417 / .46417 | .8073 / .8073 | No — exact null on MPR `.3333`, recall `.25`, binder `.6333`, tokens `54`, forwards `10`, AST/canonical `0`; candidate p50 `2680/2638` ms |
| smoke + held-out (`c1844-promote`, candidate / control) | 3 + 5 | — | — | — | — | No — Lean proved and trains completed, but candidate/control timed out on all 3 smoke and all 5 held-out documents; source sampling policy was also dropped, so model attribution is unavailable |
| smoke (`c1843-structure-token`, candidate / control) | 3 | 1.0 / 1.0 | .5278 / .5278 | .46417 / .46417 | .8073 / .8073 | No — MPR `.3333/.3333`, recall `.25/.25`, binder `.6333/.6333`, tokens `48/48`, forwards `8/8`, AST/canonical `0`; candidate p50 `2551/2607` ms is below effect floor |
| smoke (`c1842-semantic-exhaustive`, candidate / control) | 3 | 1.0 / 1.0 | .5278 / .5278 | .46417 / .46750 | .8073 / .8193 | No — MPR `.3333/.3333`, recall `.25/.25`, binder `.6333/.6333`, AST/canonical `0`; candidate tokens `48/75`, forwards `8/12`, p50 `2604/4296` ms |
| smoke + held-out (`c1841-promote`, candidate / control) | 3 + 5 | 1.0 / 1.0 | smoke `.5278/.5278`; held `.2900/.2900` | smoke `.46417/.46417`; held `.30788/.30788` | smoke `.8073/.8073`; held `.7360/.7360` | No — Lean proved, but all quality/work metrics are null; held MPR `0`, recall `.1619`, binder `.4371`, AST/canonical `0`; candidate p50 `3160/3087` ms |
| smoke (`c1839-capacity-tail`, candidate / control) | 3 | 1.0 / 1.0 | .7222 / .7222 | .4600 / .4600 | .8777 / .8777 | No — exact null on MPR `.3333`, recall `.25`, binder F1 `.8222`, tokens `75`, forwards `13`, AST/canonical 0; candidate p50 `4699/4527` ms |
| smoke (`c1838-confirm`, candidate / control) | 3 | 1.0 / 1.0 | .7222 / .7500 | .43723 / .40193 | .8657 / .8740 | No — fixture confirmation only; MPR `.3333/.3333`, recall `.25/.25`, binder F1 `.8222/.8000`, tokens `78/74`, forwards `15/16`, AST/canonical 0; promotion suites and formal preflight pending |
| smoke (`c1832-confirm`, candidate / control) | 0 / not run | — | — | — | — | No — candidate timed out 3/3 documents and control stopped at train step 2; no scoreboard or comparison |
| smoke (`c1830-capacity-tail`, candidate / control) | 3 | 1.0 / 1.0 | .7222 / .6111 | .40333 / .35057 | .8777 / .8443 | No — fixture positive only; MPR `.3333/.3333`, recall `.25/.25`, binder F1 `.8222/.7222`, tokens `99/104`, forwards `22/23`, AST/canonical 0; fresh confirmation pending |
| smoke (`c1829-capacity-aware`, candidate / control) | 3 | 1.0 / 1.0 | .7222 / .5278 | .5300 / .41973 | .8777 / .8073 | No — MPR `.6667/.3333`, recall `.4167/.1667`, binder F1 `.8222/.6333`; quality gain rejected because p50 is `4680.28/2838.60` ms and AST/canonical remain 0 |
| smoke (`c1828-wide-draft`, candidate / control) | 3 | 1.0 / 1.0 | .5278 / .5278 | .46417 / .46417 | .8073 / .8073 | No — exact quality/work null; MPR `.3333/.3333`, recall `.25/.25`, binder F1 `.6333/.6333`, draft `16/8`, AST/canonical 0 |
| smoke (`c1827-compiler-cache`, candidate / control) | 3 | 1.0 / 1.0 | .5278 / .5278 | .46417 / .46417 | .8073 / .8073 | No — exact quality/work null; MPR `.3333/.3333`, recall `.25/.25`, binder F1 `.6333/.6333`, cache hits `0/0`, AST/canonical 0 |
| smoke (`c1826-bounded-margin`, candidate / control) | 3 | 1.0 / 1.0 | 1.0 / 1.0 | .3439 / .3439 | .973 / .973 | No — exact quality/work null; MPR `.6667/.6667`, recall `.3333/.3333`, binder F1 `1/1`, tokens `201/201`, forwards `51/51`, AST/canonical 0 |
| smoke (`c1824-compiler-decision-margin`, candidate / control) | 3 | 1.0 / 1.0 | .72222 / .52778 | .4811 / .13527 | .85967 / .76533 | No — MPR `.6667/.3333`, recall `.4167/.1667`, binder F1 `.8222/.6333`; quality gain rejected because p50 is `3901.53/973.41` ms and AST/canonical remain 0 |
| smoke (`c1823-compiler-decision-token`, candidate / control) | 3 | 1.0 / 1.0 | .38889 / .38889 | .0575 / .0575 | 0 / 0 | No — fresh-seed null; MPR `0/0`, recall `0/0`, binder F1 `.48889/.48889`, AST/canonical 0, candidate p50 `1781.41` vs `1765.12` ms |
| smoke (`c1822-compiler-decision-token`, candidate / control) | 3 | 1.0 / 1.0 | 1.0 / 1.0 | .146233 / .052367 | .945 / .941 | No — fixture positive only; MPR `.6667/0`, recall `.3333/.0833`, AST/canonical 0, absolute gates fail, fresh confirmation required |
| smoke (`c1821-compiler-decision-token`, candidate / control) | 0 / 0 complete of 3 | — | — | — | — | Incomplete — both production batches timed out 3/3; no model effect is measurable and exact frozen replay is required |
| smoke (`c1819-component-edge-margin`, candidate / control) | 3 | 1.0 / 1.0 | .5278 / .9167 | .174167 / .404433 | .76533 / .92 | No — MPR `.3333/.6667`, binder F1 `.63333/.95238`, AST/canonical 0; v117 rejects the regressed quality despite faster p50 |
| smoke (`c1818-component-edge-margin`, candidate / control) | 0 / 3 complete | — / 1.0 | — / .9167 | — / .404433 | — / .92 | Incomplete — candidate failed before model construction; exact frozen replay required and control gates fail |
| held_out (`c1812-promote`, candidate / timed-out control) | 5 / 0 complete | 1.0 / — | .58 / — | .20316 / — | 0 / — | Incomplete — control timed out 5/5; Lean preflight proved, but exact frozen replay is required and absolute gates fail |
| smoke (`c1817-component-edge-token`, candidate / control) | 3 | 1.0 / 1.0 | .5278 / .5278 | .174167 / .174167 | .76533 / .76533 | No — size-matched null; MPR `.3333`, binder F1 `.6333`, AST/canonical 0, and gates fail |
| smoke (`c1812-promote`, candidate / timed-out control) | 3 / 0 complete | 1.0 / — | .7222 / — | .264167 / — | 0 / — | Incomplete — control timed out 3/3; no matched promotion claim is available |
| smoke (`c1810-confirm`, candidate / control) | 3 | 1.0 | .5278 / 0 | .174167 / .0964 | .76533 / 0 | No — fresh-seed confirmation only; MPR .3333, recall .25, and absolute gates still fail |
| smoke (`c1809-balanced-container-close`, candidate / control) | 3 | 1.0 | .5278 / 0 | .174167 / .0575 | .76533 / 0 | No — screening win only; MPR .3333, recall .25, and absolute gates fail; fresh confirmation required |
| smoke (`c1808-container-close`, weight 1 / 0) | 3 | 1.0 | 0 | .3225 | 0 | No — exact quality/decode-work tie; training wall rises 3.07→9.35 s and p50 rises 1900.30→1931.99 ms |
| smoke (`c1807-typed-family-balance`, .25 / 0) | 3 | 1.0 | 1.0 / .5278 | .104467 / .0575 | .9370 / .76533 | No — MPR remains 0, absolute structure fails, and p50 rises 1084.71→5868.74 ms |
| smoke (`c1806-structure-token`, weight 1 / 0) | 3 | 1.0 | .7222 / .5278 | .1375 / .1725 | .88267 / .80733 | No — primary structure regresses and p50 rises 2425.58→7651.84 ms |
| smoke (`c1805-component-token`, frozen candidate / control replay) | 3 / 0 complete | 1.0 / — | 1.0 / — | .081733 / — | .927 / — | No — control timeout 3/3 reproduced; candidate is only a runtime-specific unblock and fails absolute structure |
| smoke (`c1804-component-token`, candidate / timed-out control) | 3 / 0 complete | 1.0 / — | 1.0 / — | .081733 / — | .927 / — | Incomplete — control has 3 typed decode timeouts; exact frozen replay required |
| smoke (`c1803-scaffold-prefix`, weight 1 / 0) | 3 | 1.0 | .7222 | .419733 | .85367 | No — exact tie including MPR .3333, binder F1 .8222, and recall .1667; treatment worsens p50 1827.59→2001.80 ms |
| smoke (`c1802-design-dropout`, .25 / 0) | 3 | 1.0 | .5278 | .096400 / .174167 | .76533 | No — candidate MPR `.3333→0` and recall `.25→.0833`; 2.71 ms faster p50 cannot override quality regression |
| smoke (`c1801-symbol-boundary`, weight 1 / 0) | 3 | 1.0 | .5278 | .135267 | .76533 | No — exact quality tie including binder F1 .6333 and recall .1667; treatment worsens loss and p50 |
| smoke (`c1800-mixed-mask`, mixed / random) | 3 | 1.0 | .5278 | .135267 | .76533 | No — exact quality tie including binder F1 .6333 and recall .1667; candidate p50 regresses 982.53→1112.15 ms and loss 16.90084→22.29659 |
| smoke (`c1799-slot-augmentation`, true / control false) | 3 | 1.0 | .5278 / .7222 | .05750 / .13750 | 0 | No — meaningful-program and recall are 0; binder F1 regresses .8222→.6333 despite p50 improving 5,086.88→1,004.31 ms |
| smoke / held_out (`c1796-semantic-contrast`, weight .25 / control 0) | 1/3 + 4/5 / 1/3 + 0/5 complete | partial 1.0 | partial 0/.4167 / 1.0/NA | partial .06000/.16535 / .18000/NA | partial 0/.45550 / .94900/NA | Incomplete — both arms have typed decode timeouts; metrics cover different subsets and are not scoreable |
| smoke (`c1795-edge-alignment`, weight 1 / control 0) | 3 | 1.0 | .5278 | .05750 | .76533 | No — exact quality tie with meaning 0, binder F1 .6333, and recall 0; candidate p50 1,302.79 vs control 1,352.96 ms (-3.71%), below the 5% floor |
| smoke (`c1793-confirm`, fidelity 1.5 / control .5) | 3 | 1.0 | .5278 / .9167 | .44583 / .45750 | .80333 / .92000 | No — meaning .3333 and recall .25 tie, but binder F1 .6333 vs .9524 and primary structure regresses; p50 2,344.24 vs 5,018.29 ms cannot confirm quality |
| smoke (`c1791-fidelity`, weight 1.5 / control .5) | 3 | 1.0 | .5278 / .4444 | .17417 / .14593 | .76533 / .53800 | No — candidate meaning .3333 vs 0, binder F1 .6333 vs .5, recall .25 vs 0, and p50 1,088.81 vs 1,154.30 ms; fixture candidate pending fresh confirmation |
| smoke (`c1789-binder-component-plan`, candidate / incomplete control) | 3 / 2 complete | 1.0 | .7222 / 1.0 | .29667 / .12000 | .87767 / .97300 | Incomplete — control has one decode timeout; candidate p50 4,155.15 vs control 3,169.52 ms and binder F1 .8222 vs 1.0 |
| smoke (`c1788-binder-arity`, weight 1 / control 0) | 3 | 1.0 | 0 | .20583 | 0 | No — exact quality tie with meaning/binder F1 0; candidate p50 2,652.77 vs control 2,755.21 ms (-3.72%) |
| smoke (`c1786-steps`, 42 / 21 steps) | 3 | 1.0 | .5278 | .41973 / .13527 | .80733 / .76533 | No — meaning .3333 and binder F1 .6333 tie; candidate p50 2,810.05 vs control 1,105.90 ms (+154.1%) |
| smoke (`c1785-bounds`, bounds / control) | 3 | 1.0 | 0 | .05750 | 0 | No — exact quality tie with meaning/binder F1 0; candidate p50 1,135.36 vs control 1,147.14 ms |
| smoke (`c1784-confirm`, component-plan / control) | 3 | 1.0 | .7222 | .05750 | 0 | No — exact quality tie; candidate p50 1,246.97 vs control 1,373.19 ms, but meaning is 0 |
| held_out (`c1784-confirm`, component-plan / control) | 5 | 1.0 | .5800 | .08940 | 0 | No — exact quality tie with meaning .2 and binder F1 .7076; candidate p50 1,249.79 vs control 1,287.42 ms; c1783 rejected |
| smoke (`c1783-component-plan`, weight 1 / control 0) | 3 | 1.0 | .5278 | .17417 | .76533 | No — exact quality tie; candidate p50 1,059.20 vs control 1,126.88 ms gives MPR/ms +6.39%; fresh confirmation required |
| smoke (`c1782-component-plan`, weight 1 / control 0) | unavailable | unavailable | unavailable | unavailable | unavailable | Incomplete — both evaluations failed before scoreboard on an unregistered runtime flag; exact frozen replay required |
| smoke (`c1781-canvas`, reported candidate / invalid control) | 3 | 1.0 | .5278 | .17417 | .76533 | Invalid — control trained canvas-off but evaluated canvas-on; reported p50 1,086.17 / 1,046.84 ms is non-attributable |
| smoke (`c1780-component-structure`, plan+edge 1 / control 0) | 3 | 1.0 | .5278 | .17417 | .76533 | No — exact quality tie; candidate p50 1,013.25 vs control 1,082.16 ms |
| held_out (`c1780-component-structure`, plan+edge 1 / control 0) | 5 | 1.0 | .2900 | .09758 | .69400 | No — exact quality tie with meaning 0 and binder F1 .4371; candidate p50 1,091.01 vs control 1,065.64 ms |
| smoke (`c1779-binder-topology`, .25/1 / control 0/0) | 3 | 1.0 | .7222 | .11750 | .31233 | No — exact quality tie with meaning 0 and binder F1 .8222; candidate p50 1,480.73 vs control 1,426.49 ms |
| smoke (`c1778-batch1`, batch 1 / control batch 2) | 3 | 1.0 | .5278 | .17417 | .76533 | No — exact quality tie; candidate p50 1,169.59 vs control 1,084.79 ms and worse loss |
| smoke (`c1777-confirm`, component-inventory / control) | 3 | 1.0 | 0 | .05750 | 0 | No — exact quality tie with meaning/binder F1 0; candidate p50 1,217.79 vs control 1,142.29 ms; c1776 rejected |
| smoke (`c1776-component-inventory`, weights 1 / control 0) | 3 | 1.0 | .5278 / .6389 | .13527 / .13527 | .76533 / .52967 | No — meaning ties at .3333; binder F1 .6333 / .7333 and p50 1,381.80 / 1,207.83 ms; fresh confirmation required |
| held_out (`c1776-component-inventory`, weights 1 / control 0) | 5 | 1.0 | .2900 / .5467 | .10690 / .06024 | .69400 / .13140 | No — meaning .2 / 0, but binder F1 .4371 / .6648 and p50 1,494.22 / 1,276.43 ms; fixture candidate only |
| smoke (`c1775-component-edge`, train/decode 1 / control 0) | 3 | 1.0 | .5278 | .17417 | .76533 | No — exact quality tie; candidate p50 1,052.15 vs control 1,093.01 ms gives only +3.88% MPR/ms, below the 5% minimum effect |
| smoke (`c1773-literal-close`, tail 2 / control 0) | 3 | 1.0 / unavailable | 0 / unavailable | .09640 / unavailable | 0 / unavailable | No — candidate completed 3/3 while control timed out 3/3; quality delta unavailable; exact frozen replay required |
| smoke (`c1772-confirm`, bounds / control) | 3 | 1.0 | .5278 | .46417 | .80733 | No — exact quality tie; p50 2,815.53 / 2,893.13 ms; speed below confirmation threshold |
| held_out (`c1772-confirm`, bounds / control) | 5 | 1.0 | .2900 | .30788 | .73600 | No — exact quality tie; candidate p50 2,931.34 vs control 2,877.23 ms; gates fail |
| smoke (`c1771-bounds`, on / control off) | 3 | 1.0 | .7222 | .11527 | .82367 | No — exact quality/prediction tie; candidate p50 1,433.96 vs control 1,522.25 ms; fixture screening only; fresh confirmation required |
| smoke (`c1770-component-edge`, train/decode 1 / control 0) | 3 | unavailable | unavailable | unavailable | unavailable | No — both arms timed out 3/3; strict completeness forbids model-quality attribution; fresh size-matched literal-close experiment next |
| smoke (`c1766-component-plan`, weight 1 / control 0) | 3 | unavailable / 1.0 | unavailable / .5278 | unavailable / .13527 | unavailable / .76533 | No — candidate timed out 3/3; strict completeness forbids model attribution; exact frozen replay required |
| smoke (`c1765-literal-margin`, direct margin 1 / control 0) | 3 | 1.0 / 1.0 | 0 / .4444 | .11500 / .14777 | 0 / .5380 | No — candidate regresses meaning `.3333->0`, binder F1 `.5->0`, and recall `.1667->0`; complete AgentV bundles; gates fail |
| smoke (`c1764-literal-close`, tail 2 / control 0) | 3 | 1.0 | .5278 | .17417 | .76533 | No — prediction-identical; meaning .3333; AgentV 0/2 bundle; gates fail |
| held_out (`c1764-literal-close`, tail 2 / control 0) | 5 | 1.0 | .2900 | .09758 | .69400 | No — prediction-identical; meaning 0; AgentV 0/2 bundle; gates fail |
| locked local holdout (`slm287-trained-local-v13-20260725`, 5 seeds × 2 configs) | 226 | — | — | — | — | No — this protocol records raw/constrained/repaired meaning-v2 and binder/reference F1, all 0; AgentV 160/160 shard bundles; absolute-probability MDE 0.0200, diagnostic only |
...
| --- | --- | --- | --- | --- |
| 2026-08-04 | c20260804-continuous-openui-schedu-3d42338c-c2-{control,canvas} | outputs/autoresearch/continuous-loop-20260804-continuous-openui-schedu-3d42338c-c2/runs/ (local, explicit no-sync) | Both 22 CPU steps, size-matched params `1,608,962` each; `--ship-gates` eval crashed with `AgentV SDK is unavailable` (missing `npm ci`) before any scoreboard, so no quality metrics were produced | Control SHA `0ccf6221...71f4e2`; canvas SHA `44bf9cdf...681f2e`. Repaired via `2aedf3b` (self-heal AgentV bootstrap); frozen-arm replay in c3 completed the harness but hit decode timeouts (n=3, all incomplete) — no model attribution, harness-repair-only ([results](design/continuous-openui-scheduled-fe71636-c2-results.md)) |
...
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1802-{control,design-dropout}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1802/runs/` (local, explicit no-sync) | Candidate regresses structure `.174167→.096400`, recall `.25→.0833`, and MPR `.3333→0`; p50 `944.05` vs `946.76` ms; AgentV complete; gates fail | CPU `wf_smoke_v2`, 22 steps, seed 101802, matched 1,608,962 params. Control SHA `dd9d11e8...7154`; candidate SHA `212ba7ce...573b`. Lean `not_applicable:screening`; rejected ([results](design/autotrain-cycle-1802-design-dropout-rejected.md)) |
...
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1793-{control,confirm}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1793/runs/` (local, explicit no-sync) | Candidate regresses smoke structure `.45750→.44583`, binder F1 `.9524→.6333`, fidelity `.9167→.5278`, and reward `.92000→.80333`; p50 improves `5,018.29→2,344.24` ms; AgentV complete; gates fail | CPU `wf_smoke_v2`, 23 steps, seed 101793, matched 1,608,962 params. Control SHA `54348049...4c84`; candidate SHA `590fa756...a1af`. Lean `not_applicable:confirmation_rejected`; false-positive queue gate repaired, neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1793-fidelity-confirmation-rejection.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1791-{control,fidelity}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1791/runs/` (local, explicit no-sync) | Candidate improves smoke meaning `0→.3333`, structure `.14593→.17417`, binder F1 `.5→.6333`, recall `0→.25`, fidelity `.4444→.5278`, and p50 `1,154.30→1,088.81` ms; AgentV complete; gates fail | CPU `wf_smoke_v2`, 23 steps, seed 101791, matched 1,608,962 params. Control SHA `299d0aac...a5f0`; candidate SHA `d8470198...abbf`. Lean `not_applicable:screening`; exact fresh confirmation only, neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1791-fidelity-candidate.md)) |
...
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1776-{control,component-inventory}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1776/runs/` (local, explicit no-sync) | Held-out meaning/structure/reward `0/.06024/.13140→.2/.10690/.69400`; binder F1 `.6648→.4371`, p50 +17.1%; smoke meaning/structure tie | CPU `wf_smoke_v2`, 20 steps, seed 101776, matched 1,682,363 params. Control SHA `3bef9ed9...7c47b`; candidate SHA `51f05c0a...4fadf`. Lean `not_applicable:no_champion`; fresh confirmation only, neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1776-component-inventory-candidate.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1775-{control,component-edge}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1775/runs/` (local, explicit no-sync) | Exact smoke parse/meaning/structure/binder/fidelity/reward tie; p50 1,093.01→1,052.15 ms, MPR/ms +3.88%; AgentV complete; gates fail | CPU `wf_smoke_v2`, 22 steps, seed 101775, matched 1,766,987 params. Control SHA `79191075...c35ee`; candidate SHA `7fb1c6ce...d3f40`. Lean `not_applicable:screening`; candidate rejected, neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1775-component-edge-null.md)) |
...
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1764-{control,literal-close}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1764/runs/` (local, explicit no-sync) | Exact smoke and held-out prediction/quality ties; tail arm p50 1,167.26 / 1,150.26 ms vs control 1,189.39 / 1,153.93 ms; AgentV 0/2, gates fail | CPU `wf_smoke_v2`, 20 steps, seed 101764, matched 1,608,962 params. Control SHA `56cd5bae…db152`; tail SHA `5a11701c…54f5b`. Tail weight is active but quality-null; Lean `not_applicable:no_champion`. Neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1764-literal-close-null.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1760-{control,batch1}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1760/runs/` (local, explicit no-sync) | Candidate trained but eval interrupted with `measurement_complete=false`; control smoke meaning/structure/recall `.3333/.13527/.1667` and held-out `0/.06024/.02857`; AgentV 0/2, gates fail | CPU `wf_smoke_v2`, 22 steps, seed 101760, matched 1,608,962 params, batch 2 vs 1. Control SHA `bd95d451…b549dc`; candidate SHA `da3c0462…bcdcc9`. Candidate partial telemetry is diagnostic only; Lean `not_applicable:no_champion`. Exact frozen replay only; neither checkpoint promotable/ship ([results](design/autotrain-cycle-1760-batch1-incomplete.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1759-{control,confirm}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1759/runs/` (local, explicit no-sync) | Fresh-seed confirmation: control meaning/structure/recall `.3333/.17417/.25`; 44-step candidate `0/.05750/0`; p50 1,362.47→3,195.06 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, seed 101759, batch 2; matched 1,608,962-param compiler-tree arms. Control SHA `66af1bbd…fb9e011`; candidate SHA `a1fcbc81…dfa50e`. Candidate loss falls 77.00% while quality and latency regress, so c1757 is rejected; Lean `not_applicable:confirmation`. Neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1759-steps-confirmation.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1757-{control,steps}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1757/runs/` (local, explicit no-sync) | Screening candidate: 44 steps improves p50 1,346.77→1,184.95 ms and MPR/ms 13.66%, but structure `.17417→.13527` and recall `.25→.1667`; AgentV complete, gates fail | CPU `wf_smoke_v2`, seed 101757, batch 2; matched 1,608,962-param arms. Control SHA `dad20b46…501c9`; candidate SHA `5f3f64ef…f2b087`. Queued only for c1759 confirmation, which rejected it; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1757-steps-efficiency-candidate.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1754-{control,bounds}` | local no-sync c1754 runs | Exact quality/loss tie; p50 14,453.65 vs 14,431.80 ms | 24 steps, seed 101754, matched 1,608,962 params; SHAs `0716d0d2…c18ba` / `98b03a38…413c7`; clean `0ebf14cd…cc0f4`. Rejected, never reusable/promotable/ship ([results](design/autotrain-cycle-1754-completion-bounds-diagnostic.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1753-{control,component-structure}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1753/runs/` (local, explicit no-sync) | Treatment structure `.04333` vs control `.05750`; p50 1,712.01 vs 1,424.68 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, 23 steps, seed 101753, batch 2; matched 1,913,789-param compiler-tree arms. Control SHA `e6936a8c…25611`; treatment SHA `da567ef7…b78f9`. Clean code `fbfb3757dcd30fd9018aa2f0d7d7609fb3edffd9`, eval harness `v74`. Quality regression; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1753-coupled-component-structure-screen.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1752-{control,binder-topology}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1752/runs/` (local, explicit no-sync) | Exact smoke n=3 / held-out n=5 quality ties; treatment p50 4,663.12 / 4,614.14 vs control 4,398.12 / 4,573.57 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, 22 steps, seed 101752, batch 2; exactly matched 2,137,346-param compiler-tree arms. Control SHA `eddaf8dd…135d7`; treatment SHA `a38b7623…43e04`. Clean code `b3920eaf109d0e2e686e7664bfa8c31c54682c01`, harness campaign `v61`, model build eval `v74`, meaning `2.13.0`, scoring `v22`. No champion; Lean promotion proof not applicable. Neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1752-coupled-binder-topology-screen.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1751-control` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1751/runs/` (local, explicit no-sync) | 24-step control train completed; eval process exceeded stage wall; candidate rejected before training; no scoreable comparison | CPU `wf_smoke_v2`, seed 101751, batch 2, 2,137,346 params. Control SHA `c181b5c9…72007e`; candidate has no checkpoint. Clean code `1b1cfe0222a33b23629e25230137828ae9a3fde9`, harness `v60`. Compiler-path companion and failed-outcome routing require repair. Provenance-only, never reusable/promotable/ship ([results](design/autotrain-cycle-1751-coupled-topology-incomplete.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1750-{control,component-inventory}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1750/runs/` (local, explicit no-sync) | Exact smoke n=3 quality ties: parse 1.0, meaning .3333, structure .17417, recall .25, AST node/edge F1 .26190/0; treatment p50 1,123.96 vs control 1,164.70 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, 23 steps, seed 101750, batch 2; exactly matched 1,682,363-param arms. Control SHA `4731e2c0…0d01a1`; inventory SHA `b58d5de7…2ad0e7`. Clean code `73ed42c96a461fbdb61ae70b73a8124e7bc5bb57`, harness `v74`, meaning eval `2.13.0`, scoring `v22`, completion kernel `v16`, gates `openui_ship_gates_v6`. Quality null; non-zero auxiliary targets with decode weight 0 motivate a coupled successor; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1750-component-inventory-screen.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1749-{control,component-edge}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1749/runs/` (local, explicit no-sync) | Exact smoke n=3 quality ties: parse 1.0, meaning .3333, structure .17417, recall .25, AST node/edge F1 .26190/0; treatment p50 1,121.26 vs control 1,130.21 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, 22 steps, seed 101749, batch 2; exactly matched 1,766,987-param arms. Control SHA `a40040ce…ce42a70`; component-edge SHA `f4bbee59…45aa556`. Clean code `2db8db323ab856e2736f61232ec3c329a81c87ff`, harness `v74`, meaning eval `2.13.0`, scoring `v22`, completion kernel `v16`, gates `openui_ship_gates_v6`. Quality null and 0.79% efficiency gain below policy floor; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1749-component-edge-screen.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1748-{control,component-plan}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1748/runs/` (local, explicit no-sync) | Exact smoke n=3 / held-out n=5 quality ties: parse 1.0, meaning/component recall/AST F1 0, structure .05750 / .04274; treatment p50 1,357.57 / 1,336.36 vs control 1,406.90 / 1,315.32 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, 24 steps, seed 101748, batch 2; exactly matched 1,755,764-param arms. Control SHA `f66fe0ed…b71dec`; component-plan SHA `d0507f83…313a28`. Clean code `c0a1ad28ea47be328a6d95c2c1c443781c91acb7`, harness `v74`, meaning eval `2.13.0`, scoring `v22`, completion kernel `v16`, gates `openui_ship_gates_v6`. Quality null, worse candidate loss and 2.19× training wall; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1748-component-plan-screen.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1737-{control,canvas}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1737/runs/` (local, explicit no-sync) | Both trains completed; both smoke evals interrupted at 2/3 records with `measurement_complete=false` and `scoreable=false`; no AgentV, gates, quality, or latency result | CPU `wf_smoke_v2`, 22 steps, seed 101737, batch 2; exactly matched 1,608,962-param arms. Control SHA `85531461…12cb46`; canvas SHA `4669b0b6…725f8d`. Clean code `e43d05633dca9919762392f8f9485924f20902d3`. Inconclusive; checkpoints restricted to exact frozen replay and never reusable/promotable/ship ([results](design/autotrain-cycle-1737-canvas-timeout.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1736-{control,bounds}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1736/runs/` (local, explicit no-sync) | Exact smoke n=3 / held-out n=5 quality ties: parse 1.0 / 1.0, meaning 0 / 0, structure .0575 / .0894; bounds p50 3,072.99 / 3,177.65 vs control 2,933.21 / 3,058.12 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, 24 steps, seed 101736, batch 2, `honest_slot_contract=True`; exactly matched 1,608,962-param arms. Control SHA `1383c5a9…fd2c4f`; bounds SHA `a6113951…da0f3b`. Clean code `f22d2e89df5f0949a502c7227ea1dbf174cfefdd`, harness `v73`, meaning eval `2.13.0`, scoring `v22`, gates `openui_ship_gates_v6`. Quality null, slower on both suites, no champion/Lean campaign certificate; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1736-bounds-promotion-screen.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1735-{control,component-structure}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1735/runs/` (local, explicit no-sync) | Exact smoke n=3 quality ties: parse 1.0, meaning .3333, structure .17417, binder F1 .6333, recall .25; treatment p50 1,589.07 vs 1,509.10 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, 23 steps, seed 101735, batch 2, evaluation `honest_slot_contract=True`; exactly matched 1,913,789-param arms. Control SHA `927220da…e7b5e9`; treatment SHA `f5b3f51c…ad6a52`. Clean code `3cb2dc107960119e9e75c50f322c21c0eb8039c3`, harness `v73`, meaning eval `2.13.0`, scoring `v22`, gates `openui_ship_gates_v6`. Quality null, 5.30% slower, and 3.04× training wall; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1735-component-structure-screen.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1734-{control,component-inventory}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1734/runs/` (local, explicit no-sync) | Exact smoke n=3 quality ties: parse 1.0, meaning .3333, structure .17417, binder F1 .6333, recall .25; treatment p50 1,567.47 vs 1,574.83 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, 22 steps, seed 101734, batch 2, evaluation `honest_slot_contract=True`; exactly matched 1,682,363-param arms. Control SHA `0e2cac42…0afe28`; treatment SHA `4b61fecf…549229`. Clean code `2b2c33166d8ee207cdf2bdf1f5825bc70959420b`, harness `v73`, meaning eval `2.13.0`, scoring `v22`, gates `openui_ship_gates_v6`. Quality null and 0.47% efficiency gain below policy floor; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1734-component-inventory-screen.md)) |
| 2026-08-02 | `c20260802-continuous-openui-202607-98199209-c1733-{control,component-edge}` | `outputs/autoresearch/continuous-loop-20260802-continuous-openui-202607-98199209-c1733/runs/` (local, explicit no-sync) | Exact smoke n=3 quality ties: parse/binder F1 1.0, meaning 0, structure .20693, recall .08333; treatment p50 6,005.56 vs 6,136.43 ms; AgentV complete, gates fail | CPU `wf_smoke_v2`, 24 steps, seed 101733, batch 2, evaluation `honest_slot_contract=True`; exactly matched 1,766,987-param arms. Control SHA `19033055…eafd52b`; treatment SHA `f6f4d361…306cfe6`. Clean code `a88ea74133115d0ed8850bc0bf49ab5456d7828d`, harness `v73`, meaning eval `2.13.0`, scoring `v22`, gates `openui_ship_gates_v6`. Quality null and 2.13% efficiency gain below policy floor; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1733-component-edge-screen.md)) |
| 2026-08-02 | Control `c20260801-continuous-openui-202607-98199209-c1732-control`; treatment `c20260801-continuous-openui-202607-98199209-c1732-component-plan` | `outputs/autoresearch/continuous-loop-20260801-continuous-openui-202607-98199209-c1732/runs/` (local, explicit no-sync) | Exact quality ties on smoke n=3 (parse 1.0, meaningful .3333, structure .2153, binder F1 .8222) and held-out n=5 (parse 1.0, meaningful 0, structure .06024, binder F1 .7076); treatment p50 2,066.56 vs 2,057.09 ms smoke and 1,665.84 vs 1,734.45 ms held-out; AgentV complete, `--ship-gates` fail | CPU `wf_smoke_v2`, 23 steps, seed 101732, batch 2, `honest_slot_contract=True`; exactly matched 1,755,764-param arms. Control SHA `ea4f5f32…0046c27`; treatment SHA `bee24d60…7c2cc2e`. Stamp `version_stamp/v1`, clean code `fbfc16ae6372cbccd9c8e1d30f755678ad6ffd19`, harness `v73`, meaning eval `2.13.0`, scoring `v22`, gates `openui_ship_gates_v6`, eval recipe `e938_role_safe_all_targets_v2`. Third component-plan quality null; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1732-component-plan-promotion-screen.md)) |
| 2026-08-02 | `c20260801-continuous-openui-202607-98199209-c1731-{control,component-plan}` | `outputs/autoresearch/continuous-loop-20260801-continuous-openui-202607-98199209-c1731/runs/` (local, explicit no-sync) | Both smoke n=3: parse 1.0, meaningful .3333, structure .4197, binder F1 .6333, recall .1667; control p50 3,453.06 ms, treatment 3,430.55 ms; AgentV complete, gates fail | Exactly matched 1,755,764-param arms. Control SHA `126e390e…81a3d`; treatment SHA `ed9e630e…b5c2b`. Quality-null and 0.65% latency delta is below policy v4's 5% efficiency floor; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1731-component-plan-replication.md)) |
| 2026-08-02 | `c20260801-continuous-openui-202607-98199209-c1730-{control,component-plan}` | `outputs/autoresearch/continuous-loop-20260801-continuous-openui-202607-98199209-c1730/runs/` (local, explicit no-sync) | Both smoke n=3: parse 1.0, meaningful .3333, structure .1742, binder F1 .6333, recall .25; control p50 1,798.92 ms, treatment 1,560.93 ms; AgentV complete, gates fail | Exactly matched 1,755,764-param arms. Control SHA `d1acb3c0…aae35`; treatment SHA `4e70baaa…aff30`. Quality-null with a 13.23% fixture p50 signal queued for new-seed confirmation; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1730-component-plan-screen.md)) |
| 2026-08-02 | `c20260801-continuous-openui-202607-98199209-c1729-{control,binder-topology}` | `outputs/autoresearch/continuous-loop-20260801-continuous-openui-202607-98199209-c1729/runs/` (local, explicit no-sync) | Both smoke n=3: parse 1.0, structure .0575, meaningful/binder F1 0.0; control p50 1,520.36 ms, treatment 1,532.49 ms; AgentV complete, gates fail | Control SHA `e16840b5…e5b35` at 1,608,962 params; treatment SHA `655e7e30…8396d` at 2,137,346 params. Null, +32.84% capacity-confounded, rejected; neither checkpoint reusable/promotable/ship ([results](design/autotrain-cycle-1729-binder-topology-capacity-audit.md)) |
| 2026-08-01 | `c20260801-continuous-openui-202607-98199209-c1717-control` | `outputs/autoresearch/continuous-loop-20260801-continuous-openui-202607-98199209-c1717/runs/` (local, explicit no-sync) | Control smoke n=3: parse/binder F1 1.0, meaningful .3333, structure .3656, p50 3,954.45 ms, AgentV complete, gates fail; batch1 train timed out and produced no checkpoint/eval | Control SHA `e38a18ad…7c54ee` again matches c1715/c1716. Redundant frozen retraining consumed the candidate stage; measurement incomplete and no checkpoint is reusable/promotable/ship ([results](design/autotrain-cycle-1717-redundant-retrain-timeout.md)) |
...
## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c39)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c39`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c39-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c39-symbol-boundary/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c40)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c40`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c40-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c40-mixed-mask/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c41)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c41`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c41-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c41-symbol-boundary/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c42)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c42`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c42-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c42-design-dropout/checkpoints/last.pt`
...
## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c43)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c43`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c43-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c43-scaffold-prefix/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c44)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c44`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c44-confirm/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c44-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c45)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c45`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c45-batch1/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c45-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c46)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c46`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c46-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c46-design-dropout/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c47)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c47`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c47-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c47-scaffold-prefix/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c48)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c48`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c48-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c48-scaffold-prefix-structure/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c49)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c49`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c49-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c49-scaffold-prefix-tail/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c50)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c50`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c50-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c50-scaffold-prefix-structure/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c51)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c51`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c51-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c51-scaffold-prefix-tail/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c52)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c52`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c52-component-token/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c52-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c53)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c53`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c53-component-token-prefix/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c53-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c54)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c54`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c54-component-token/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c54-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c55)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c55`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c55-component-token-prefix/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c55-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c56)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c56`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c56-component-edge-token/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c56-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c57)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c57`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c57-component-edge-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c57-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c58)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c58`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c58-component-edge-token/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c58-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c59)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c59`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c59-confirm/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c59-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c60)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c60`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c60-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c60-literal-margin/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c61)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c61`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c61-component-edge-token/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c61-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c62)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c62`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c62-component-edge-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c62-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c63)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c63`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c63-compiler-decision-token/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c63-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c64)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c64`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c64-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c64-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c65)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c65`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c65-compiler-decision-token/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c65-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c66)
...
## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c68)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c68`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c68-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c68-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c69)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c69`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c69-bounded-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c69-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c70)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c70`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c70-cached-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c70-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c71)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c71`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c71-bounded-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c71-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c72)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c72`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c72-cached-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c72-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c74)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c74`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c74-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c74-wide-draft-compiler-decision-margin/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c75)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c75`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c75-capacity-aware-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c75-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c77)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c77`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c77-bounds/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c77-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c78)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c78`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c78-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c78-wide-draft-compiler-decision-margin/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c79)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c79`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c79-capacity-aware-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c79-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c80)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c80`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c80-capacity-aware-tail-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c80-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c82)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c82`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c82-canvas/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c82-control/checkpoints/last.pt`
...
## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c83)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c83`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c83-capacity-aware-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c83-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c84)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c84`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c84-capacity-aware-tail-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c84-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c85)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c85`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c85-capacity-aware-semantic-exhaustive-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c85-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c87)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c87`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c87-confirm/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c87-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c89)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c89`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c89-capacity-aware-tail-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c89-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c91)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c91`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c91-canvas/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c91-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c92)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c92`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c92-capacity-aware-tail-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c92-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c93)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c93`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c93-capacity-aware-semantic-exhaustive-compiler-decision-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c93-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c94)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c94`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c94-capacity-aware-semantic-exhaustive-structure-token-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c94-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c95)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c95`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c95-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c95-exposure-targeted-compiler-decision-margin/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c96)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c96`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c96-capacity-aware-semantic-exhaustive-structure-token-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c96-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c98)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c98`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c98-both/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c98-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c99)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c99`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c99-capacity-aware-semantic-exhaustive-structure-token-margin/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c99-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c101)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c101`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c101-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c101-exposure-targeted-compiler-decision-margin/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c102)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c102`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c102-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c102-exposure-targeted-semantic-exhaustive-compiler-decision-margin/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c103)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c103`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c103-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c103-structure-token/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c104)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c104`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c104-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c104-exposure-targeted-semantic-exhaustive-compiler-decision-margin/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c105)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c105`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c105-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c105-structure-token/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c106)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c106`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c106-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c106-typed-family-balance/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c107)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c107`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c107-container-close/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c107-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c108)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c108`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c108-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c108-typed-family-balance/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c109)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c109`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c109-container-close/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c109-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c110)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c110`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c110-confirm/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c110-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c111)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c111`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c111-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c111-literal-margin/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c112)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c112`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c112-container-close/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c112-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c113)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c113`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c113-balanced-container-close/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c113-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c114)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c114`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c114-component-structure/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c114-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c115)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c115`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c115-balanced-container-close/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c115-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c116)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c116`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c116-component-structure/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c116-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c117)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c117`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c117-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c117-literal-close-structure/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c118)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c118`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c118-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c118-literal-close-component-token/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c119)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c119`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c119-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c119-literal-close-structure/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c120)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c120`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c120-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c120-literal-close-component-token/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c121)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c121`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c121-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c121-literal-close-typed-balance/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c122)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c122`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c122-confirm/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c122-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c123)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c123`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c123-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c123-literal-close/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c124)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c124`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c124-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c124-literal-close-typed-balance/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c125)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c125`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c125-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c125-symbol-boundary-structure/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c126)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c126`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c126-confirm/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c126-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c127)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c127`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c127-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c127-literal-close/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c128)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c128`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c128-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c128-symbol-boundary-structure/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c129)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c129`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c129-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c129-semantic-contrast-structure/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c130)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c130`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c130-both/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c130-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c131)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c131`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c131-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c131-semantic-contrast-structure/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c132)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c132`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c132-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c132-steps/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c133)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c133`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c133-confirm/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c133-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c134)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c134`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c134-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c134-slot-component-coverage/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c135)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c135`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c135-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c135-slot-component-exposure-cap/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c136)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c136`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c136-confirm/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c136-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c137)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c137`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c137-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c137-slot-component-exposure-cap/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c138)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c138`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c138-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c138-slot-component-coverage/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c139)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c139`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c139-compose-ltr-tail-ltr-prefix/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c139-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c141)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c141`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c141-compose-ltr-tail-symbol-boundary/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c141-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c142)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c142`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c142-compose-ltr-tail-symbol-boundary/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c142-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c143)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c143`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c143-compose-ltr-tail-symbol-boundary/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c143-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c145)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c145`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c145-compose-ltr-tail-symbol-boundary/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c145-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c146)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c146`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c146-confirm/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c146-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c147)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c147`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c147-control/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c147-literal-close/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c149)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c149`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c149-compose-ltr-tail-symbol-boundary/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c149-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

## Continuous autotrain note (2026-08-09, continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c150)

- campaign: `continuous-loop-20260809-continuous-openui-schedu-e9c397aa-c150`
- checkpoints: `runs/c20260809-continuous-openui-schedu-e9c397aa-c150-compose-ltr-tail-symbol-boundary/checkpoints/last.pt`, `runs/c20260809-continuous-openui-schedu-e9c397aa-c150-control/checkpoints/last.pt`
- honesty: fixture/scratch continuous cycle — **not** a ship promotion.

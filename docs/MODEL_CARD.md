...
| --- | --- | --- | --- | --- |
| E1069 331-step exposure control | `e1069_v271_331_step_control` | CPU scratch role-safe matched-exposure control | `outputs/runs/e1069_v271_331_step_control/checkpoints/last.pt` (local) | First bounded invocation reached 316/331 steps / 95.32s, SHA `9f4a52e6...213bcb0`; own full-state resume pending for 15 steps — **not yet comparable; never sync/promote/serve/use as another run's parent** ([results](design/iter-e1045-e1051-typed-binder-candidates-20260722.md)) |
...
| --- | --- | --- | --- | --- |
| 2026-07-23 | `e1069_v271_331_step_control` | `outputs/runs/e1069_v271_331_step_control/` (local) | 316/331 control steps completed; no evaluation or causal comparison yet | 95.32s, SHA `9f4a52e6...213bcb0`; resume only its own full-state checkpoint for 15 steps |

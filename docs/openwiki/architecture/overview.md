...
| Serving / web | `src/slm_training/web/` | Annotate playground API; Vercel FastAPI entry |
...
See [`docs/design/research-lineage.md`](../../design/research-lineage.md) for paper → implementation pointers (remask, grammar fastpath, speculative denoising, verifier-guided repair).

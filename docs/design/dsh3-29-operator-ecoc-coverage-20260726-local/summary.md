# DSH3-29 cost-aware ECOC coverage (SLM-404)
...
| `local_flat` | `enabled` | 11 | 0.000 | 0.000 | 0 | 0 |
...
| `independent_set` | `enabled` | 11 | 0.000 | 0.000 | 0 | 0 |
...
| `recurrent_set` | `enabled` | 11 | 0.000 | 0.000 | 0 | 0 |
...
Decision: `reject` — no COMPLETE held-out shadow rows for the controlled coverage matrix

...
**RESEARCH-03 (Big-Five Lean package):** [iter-revmath-research-03-preregistered.md](iter-revmath-research-03-preregistered.md) (default-off; completed accept under campaign lock).
...
**RESEARCH-09 (treewidth/param VSS pilot):** [iter-revmath-research-09-preregistered.md](iter-revmath-research-09-preregistered.md) (default-off; rejected — correctness ok, treewidth proxy did not beat flat size).

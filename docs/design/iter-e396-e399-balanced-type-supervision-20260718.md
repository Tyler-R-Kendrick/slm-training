...
It has no new loss-suite result and inherits best weighted NLL 5.8091. At this
stage it was explicitly not synced or promoted; after E479 passed the complete
ship-gate board, its artifacts were synced and verified at
`hf://buckets/TKendrick/OpenUI/checkpoints/e396-balanced-type-head-continuation-r1/`.
The resulting reference remains diagnostic because some provenance hashes are
unknown.
...
it fixes the held-out type-recall gate and preserves 4/4 bounded AgentV. Later
E479 full-RICO evidence promoted it to the diagnostic champion and its bucket
copy is verified. Do not claim production HF ship: fresh NLL is missing,
provenance is incomplete, and this original bounded evaluation includes only a
matched RICO-48 shard that regresses structure and recall modestly.

...
E649 paired E647's visible-role-inferred semantic-plan families with direct
...
The capped run was originally launched as E643. It was renumbered E649 when
...
| OOD `n=4` | E637 r2 baseline | E649 r1 |
| --- | ---: | ---: |
...
The result exactly reproduced E647's quality profile apart from runtime noise.
...
rebasing onto E648 restoration v89, the append-only lineage records E649 as
treatment v90 and restoration v91. A future lever must plan concrete `(family,
role)` obligations rather than
infer family counts and bind them independently. No checkpoint was created,
synced, or promoted.

Evidence: [JSON](iter-e649-bound-role-plans-20260720.json).

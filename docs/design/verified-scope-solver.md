...
program with the pack oracle.

This is fixture wiring only (`tests/test_dsl/test_surface_realization.py` and
`tests/test_data/test_progspec.py`). The deterministic baseline remains the

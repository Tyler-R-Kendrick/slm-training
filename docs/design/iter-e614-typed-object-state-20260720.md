...
The matched OOD `n=4` replay completed normally in 28.6 seconds with no decode
...
and p95 latency falls 19.20→11.92 seconds. Component recall returns from the
...
0.7148→0.9020. The cost is eight emitted tokens, +0.31 seconds p50, and
+0.46 seconds p95. Retain the generalized grammar repair and use the E614

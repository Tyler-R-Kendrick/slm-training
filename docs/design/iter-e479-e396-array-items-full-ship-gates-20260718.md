...
**Verdict:** accept E479 as the current-policy ship-gate evidence for the
unchanged E396 diagnostic champion. Its artifacts are durably synced and
verified at
`hf://buckets/TKendrick/OpenUI/checkpoints/e396-balanced-type-head-continuation-r1/`.
This is not a production HF ship claim because the generated references retain

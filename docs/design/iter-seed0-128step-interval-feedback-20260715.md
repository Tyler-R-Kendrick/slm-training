...
The harness selected `best_weighted_nll.pt` at step 64. Evaluating that
checkpoint through bounded constrained decoding reproduced structural
similarity **0.2333**, placeholder validity **0.2667**, and component recall
**0.25**, while parse and reward remained **0**. Training telemetry recorded
loss-suite cost explicitly: loss suites were 39.84% of the 56,979 ms run.

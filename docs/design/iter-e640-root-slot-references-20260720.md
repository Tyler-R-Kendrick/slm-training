...
E640 tracked the visible slots contained by every completed top-level section.
...
| OOD `n=4` | E637 r2 baseline | E640 r1 |
| --- | ---: | ---: |
...
behavior. After rebasing onto E639 restoration v82, the append-only lineage
records E640 as treatment v83 and restoration v84. The next lever must improve
coverage inside the planned ImageGallery subtree. No checkpoint was created,
synced, or promoted.

Evidence: [JSON](iter-e640-root-slot-references-20260720.json).

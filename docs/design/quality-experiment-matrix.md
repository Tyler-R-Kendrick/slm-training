...
E383 covers disjoint RICO rows 192–240 under the unchanged capacity-safe
policy: parse/meaningful 1.0, fidelity 0.9878, structure 0.6253, recall 0.9896,
reward 0.9939, and zero failures in approximately 83s. E384 merges
E377+E378+E381+E383 into exact contiguous 240/1500 evidence: fidelity 0.9903,
structure 0.6422, recall 0.9816, reward 0.9952, and zero failures. The merged
AgentV bundle remains fail-closed because bounded suites and full RICO are
absent. Continue 48-row shards under the hard 290-second command cap. See
...
E387 covers disjoint RICO rows 288–336 under the unchanged capacity-safe
policy: parse/meaningful 1.0, fidelity 0.9826, structure 0.6278, recall 0.9549,
reward 0.9929, and zero failures in approximately 87s. E388 merges all six
shards into exact contiguous 336/1500 evidence: fidelity 0.9893, structure
0.6366, recall 0.9764, reward 0.9949, and zero failures. The merged AgentV
bundle remains fail-closed because bounded suites and full RICO are absent.
Continue 48-row shards under the hard 290-second command cap. See
...
96-row shards, each externally capped at 290 seconds. Shards 0–2 (rows 0–288)
...
gate metrics. Shard 9 reaches row 959 metric-identical to E460 at structure
0.8981 and reward 0.9932. Shard 10 reaches row 1055 at structure 0.8671 (from
...
0.9948. Shards 6a and 6b extend through row 335 and are prediction-identical
to E477 at combined structure 0.8894 and reward 0.9907. Shards 7a and 7b

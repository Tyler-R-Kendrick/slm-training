...
**Experiment preregistry (RESEARCH-02):** [research-experiment-preregistry.md](research-experiment-preregistry.md).
...
| **Negative boundary** | none of the eleven claims is `negative` -- four unresolved claims are `unavailable` (a real preflight/audit confirmed its own prerequisite absent: DSH5-03's crossover fanout wiring, DSH5-09's router admission preflight, DSH5-11's repository-wide TSA/template-manifest audit, and every DSH5 abstraction's systems-efficiency measurement) |

# E259 — C3 corpus-mined macro tokens with deterministic expansion (2026-07-17)
...
E259 recipe: `--matrix v12 --only E259 --steps 80 --device cpu
...
- This v12 run has **no matched no-macro control row**; the

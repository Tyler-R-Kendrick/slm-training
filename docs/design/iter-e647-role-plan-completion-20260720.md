...
E647 filled visible roles that no prompt-planned family could own using the
...
The capped run was originally launched as E641. It was renumbered E647 when
...
| OOD `n=4` | E637 r2 baseline | E647 r1 |
| --- | ---: | ---: |
...
After rebasing onto E646 restoration v85, the append-only lineage records E647
as treatment v86 and restoration v87. A future role-plan lever must bind each
...
Evidence: [JSON](iter-e647-role-plan-completion-20260720.json).

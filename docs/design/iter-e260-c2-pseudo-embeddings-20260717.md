# E260 — C2 dynamic pseudo-embeddings for symbol tokens (2026-07-17)
...
Row E260 (`--matrix v13`): scratch-control train, fixture v1 corpus, 200 CPU
...
JSON: [quality-matrix-results-iter-v13-c2-20260717.json](quality-matrix-results-iter-v13-c2-20260717.json);
binding probe: [binding-consistency-e260-20260717.json](binding-consistency-e260-20260717.json).

The first E260 attempt crashed with `runtime symbol feature batch 4 != 5` —
the stale-feature leak PR #275 diagnosed (features set for a training batch
outliving it into a differently-sized eval forward). E260 is the first
...
| Suite (n) | structural similarity E255 → E260 |
| --- | ---: |
| smoke (3) | 0.300 → 0.189 |
...
**Binding-consistency probe** (trained E260 checkpoint, 6 surfaces across

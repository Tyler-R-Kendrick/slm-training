...
E633 extends the existing public-schema role policy through E614's typed object
...
Dashboard, modal, and auth predictions remain unchanged. Retain E633 as the
...
Evidence: [JSON](iter-e633-typed-object-slot-role-20260720.json).

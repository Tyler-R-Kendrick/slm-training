...
| **Structural validity** | Is the plan valid under the PDDL? | Is the program parseable / typed / placeholder-legal OpenUI? | `@openuidev/lang-core` + Lark DFA (`grammar_backends/`, `grammar_fastpath/`) |

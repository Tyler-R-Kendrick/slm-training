...
schema-derived candidates at weights 4 and 8. The weight-8 schema arm was
repeated after rebasing onto current main to preserve an auditable exact code
SHA; the rerun is prediction- and metric-identical.
...
Every run reports meaning-v1/v2 0.50/0.00, fidelity 0.5917, validity 0.7550,

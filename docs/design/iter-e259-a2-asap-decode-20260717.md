# E259 — A2 ASAp-style distribution-aware constrained MaskGIT decode (2026-07-17)
...
Row E259 (`--matrix v12`) is **eval-only**: routed through the frozen E255
...
`tests/test_scripts/test_quality_matrix_v12.py` enforces the matched-pair
...
JSON: [quality-matrix-results-iter-v12-a2-20260717.json](quality-matrix-results-iter-v12-a2-20260717.json)
(scoreboards, gates, AgentV envelope under `outputs/runs/qx_e259_a2_asap_decode/`).
...
| Suite (n) | Metric | E255 control | E259 A2 |
| --- | --- | ---: | ---: |
